...
[<img src="https://raw.githubusercontent.com/jstumpp/awesome-android/master/awesome-android.png">](https://github.com/jstumpp/awesome-android) ⭐ 12,108 | 🐛 76 | 📅 2025-10-27
...
A curated list of awesome Android [libraries](#libraries) and [resources](#resources). For general Java libraries have a look at [awesome-java](https://github.com/akullpp/awesome-java) ⭐ 47,918 | 🐛 8 | 📅 2026-04-12.
...
* [Dagger 2](https://github.com/google/dagger) ⭐ 17,702 | 🐛 358 | 🌐 Java | 📅 2026-05-08 - A fast dependency injector for Android and Java.
...
* [Libgdx](https://libgdx.badlogicgames.com/) - Cross-platform game engine and SDK. [Open Source](https://github.com/libGDX/libGDX) ⭐ 25,085 | 🐛 327 | 🌐 Java | 📅 2026-05-13
...
* [FloatingView](https://github.com/UFreedom/FloatingView) ⭐ 1,804 | 🐛 3 | 🌐 Java | 📅 2019-05-24 - FloatingView can make the target view floating above the anchor view with cool animation.
...
* [SlidingTutorial](https://github.com/Cleveroad/slidingtutorial-android) ⭐ 2,454 | 🐛 3 | 🌐 Java | 📅 2018-11-19 - Simple library that helps to create awesome sliding android app tutorials.
...
* [Compressor](https://github.com/zetbaitsu/Compressor) ⭐ 7,218 | 🐛 140 | 🌐 Kotlin | 📅 2026-03-05 - Compressor is a lightweight and powerful android image compression library.
...
* [Glide](https://github.com/bumptech/glide) ⭐ 35,025 | 🐛 638 | 🌐 Java | 📅 2026-05-14 - An image loading and caching library for Android focused on smooth scrolling, Recommended by Google.
* [Picasso](https://github.com/square/picasso) ⭐ 18,832 | 🐛 214 | 🌐 Kotlin | 📅 2024-11-06 - A powerful image downloading and caching library for Android.
* [Fresco](https://github.com/facebook/fresco) ⭐ 17,150 | 🐛 257 | 🌐 Java | 📅 2026-05-13 - An Android library for managing images and the memory they use.
...
* [Coil](https://github.com/coil-kt/coil) ⭐ 11,779 | 🐛 64 | 🌐 Kotlin | 📅 2026-05-13 - Image loading for Android backed by Kotlin Coroutines.
...
* [Exoplayer](https://github.com/google/ExoPlayer) ⭐ 21,925 | 🐛 631 | 🌐 Java | 📅 2025-12-23 - ExoPlayer is an application level media player for Android, allow  playing audio and video both locally and over the Internet.
...
* [Gson](https://github.com/google/gson) ⭐ 24,203 | 🐛 338 | 🌐 Java | 📅 2026-05-06 - Gson is a Java library used for serializing and deserializing Java objects from and into JSON.
* [Moshi](https://github.com/square/moshi) ⭐ 10,131 | 🐛 98 | 🌐 Kotlin | 📅 2026-05-14 - A modern JSON library for Android and Java.
...
* [OkHttp](https://github.com/square/okhttp) ⭐ 46,967 | 🐛 110 | 🌐 Kotlin | 📅 2026-05-14 - An HTTP+SPDY client for Android and Java applications.
...
* [LeakCanary](https://github.com/square/leakcanary) ⭐ 29,921 | 🐛 164 | 🌐 Kotlin | 📅 2026-03-24 - Catch memory leaks as they occur.
...
* [Android Debug Bridge - ADB](https://github.com/mzlogin/awesome-adb/blob/master/README.en.md) ⭐ 12,303 | 🐛 50 | 📅 2024-12-18 - a command-line tool to assist in debugging Android-powered devices
* [Android Debug Database](https://github.com/amitshekhariitbhu/Android-Debug-Database) ⭐ 8,656 | 🐛 83 | 🌐 Java | 📅 2026-02-05 - Android Debug Database is a powerful library for debugging databases and shared preferences in Android applications.
...
* [ADB Enhanced](https://github.com/ashishb/adb-enhanced) ⭐ 1,372 | 🐛 0 | 🌐 Python | 📅 2026-05-12 - a command-line wrapper around ADB for developers, so that, developers don't have to remember esoteric version-dependent commands
...
* [Guava: Google Core Libraries for Java](https://github.com/google/guava) ⭐ 51,495 | 🐛 734 | 🌐 Java | 📅 2026-05-12 - Collections, caching, primitives support, concurrency libraries, common annotations, string processing, I/O, and so forth.
* [RxJava](https://github.com/ReactiveX/RxJava) ⭐ 48,255 | 🐛 20 | 🌐 Java | 📅 2026-05-13- RxJava – Reactive Extensions for the JVM – a library for composing asynchronous and event-based programs using observable sequences for the Java VM.
* [ZXing Android-Integration](https://github.com/zxing/zxing) ⭐ 33,937 | 🐛 3 | 🌐 Java | 📅 2026-05-12 - Integration with Barcode Scanner via Intent.
...
* [AboutLibraries](https://github.com/mikepenz/AboutLibraries) ⭐ 4,291 | 🐛 6 | 🌐 Kotlin | 📅 2026-05-07 - Automatically generates an About this app section, with a list of used libraries.
...
* [Android Architecture Blueprints](https://github.com/android/architecture-samples) ⭐ 45,684 | 🐛 220 | 🌐 Kotlin | 📅 2026-05-13 - The Android Architecture Blueprints project demonstrates strategies to help solve or avoid common android problems.
* [Android Modular Architecture](https://github.com/VMadalin/kotlin-sample-app) ⭐ 2,437 | 🐛 4 | 🌐 Kotlin | 📅 2021-08-23 - Android Sample App using modular, clean, scalable, testable Architecture written in Kotlin following the best practices with Jetpack.
...
* [React Native](https://github.com/facebook/react-native) ⭐ 125,801 | 🐛 1,300 | 🌐 C++ | 📅 2026-05-14 - A framework for building native apps with React by Facebook.
* [Capacitor](https://github.com/ionic-team/capacitor) ⭐ 15,661 | 🐛 117 | 🌐 TypeScript | 📅 2026-05-13 - Build cross-platform Native Progressive Web Apps for iOS, Android, and the web. Very promising Cordova alternative.
...
Other amazingly awesome lists can be found in the [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,422 | 🐛 54 | 🌐 Ruby | 📅 2024-06-02 list.
