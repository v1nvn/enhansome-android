...
[<img src="https://raw.githubusercontent.com/jstumpp/awesome-android/master/awesome-android.png">](https://github.com/jstumpp/awesome-android) ⭐ 12,012 | 🐛 69 | 📅 2025-10-27
...
A curated list of awesome Android [libraries](#libraries) and [resources](#resources). For general Java libraries have a look at [awesome-java](https://github.com/akullpp/awesome-java) ⭐ 47,397 | 🐛 21 | 📅 2026-02-07.
...
* [MPAndroidChart](https://github.com/PhilJay/MPAndroidChart) ⭐ 38,227 | 🐛 2,189 | 🌐 Java | 📅 2025-06-05 - An Android chart and graph library supporting scaling and dragging by gesture.
* [HelloCharts](https://github.com/lecho/hellocharts-android) ⭐ 7,795 | 🐛 293 | 🌐 Java | 📅 2021-06-01 - Chart and graph library with support for scaling, scrolling and animations.
* [WilliamChart](https://github.com/diogobernardino/WilliamChart) ⭐ 5,111 | 🐛 35 | 🌐 Kotlin | 📅 2025-10-04 - Chart library with good motion capabilities.
...
* [EazeGraph](https://github.com/blackfizz/EazeGraph) ⭐ 1,597 | 🐛 52 | 🌐 Java | 📅 2016-11-11 - Chart and graph library.
...
* [Anvil](https://github.com/anvil-ui/anvil) ⭐ 1,441 | 🐛 41 | 🌐 Java | 📅 2021-05-29 - A small library to create reactive UI components, inspired by React. Provides data binding and event listener binding, fits well for MVVM.
...
* [Dagger 2](https://github.com/google/dagger) ⭐ 17,710 | 🐛 365 | 🌐 Java | 📅 2026-03-13 - A fast dependency injector for Android and Java.
...
* [Libgdx](https://libgdx.badlogicgames.com/) - Cross-platform game engine and SDK. [Open Source](https://github.com/libGDX/libGDX) ⭐ 24,947 | 🐛 332 | 🌐 Java | 📅 2026-03-25
* [Rajawali](https://github.com/Rajawali/Rajawali) ⭐ 2,416 | 🐛 190 | 🌐 Java | 📅 2023-04-13 - Android OpenGL ES 2.0/3.0 Engine
* [JustWeEngine](https://github.com/lfkdsk/JustWeEngine) ⭐ 773 | 🐛 6 | 🌐 Java | 📅 2020-10-01 - An easy open source Android Native Game FrameWork.
...
* [Themis](https://github.com/cossacklabs/themis) ⭐ 1,955 | 🐛 32 | 🌐 C | 📅 2026-01-09 - Multi-language framework for making typical encryption schemes easy to use: data at rest, authenticated data exchange, transport protection, authentication, and so on.
...
* [Litho (By Facebook)](https://github.com/facebook/litho) ⭐ 7,781 | 🐛 110 | 🌐 Kotlin | 📅 2026-03-23 - A declarative framework for building efficient UIs on Android.
...
* [Cardslib](https://github.com/gabrielemariotti/cardslib) ⭐ 4,632 | 🐛 183 | 🌐 Java | 📅 2021-11-18 - Android Library to build a UI Card.
...
* [MaterialIntroScreen](https://github.com/TangoAgency/material-intro-screen) ⭐ 2,697 | 🐛 57 | 🌐 Java | 📅 2020-09-19 - Material Intro Screen implementation with easily extensible API.
* [ShimmerLayout](https://github.com/team-supercharge/ShimmerLayout) ⭐ 2,525 | 🐛 18 | 🌐 Java | 📅 2020-03-26 - Memory efficient shimmering effect for Android applications.
...
* [MaterialProgressBar](https://github.com/zhanghai/MaterialProgressBar) ⭐ 2,233 | 🐛 7 | 🌐 Java | 📅 2020-07-03 - Material design ProgressBar with consistent appearance.
* [TastyToast](https://github.com/yadav-rahul/TastyToast) ⭐ 2,022 | 🐛 19 | 🌐 Java | 📅 2019-08-20 - Toasts with icons and color.
* [AndroidFillableLoaders](https://github.com/JorgeCastilloPrz/AndroidFillableLoaders) ⭐ 1,980 | 🐛 15 | 🌐 Java | 📅 2022-07-20 - Fillable progress view working with SVG paths. Nice option too for creating interesting app logos.
* [FloatingView](https://github.com/UFreedom/FloatingView) ⭐ 1,808 | 🐛 3 | 🌐 Java | 📅 2019-05-24 - FloatingView can make the target view floating above the anchor view with cool animation.
...
* [Bubbles for Android](https://github.com/txusballesteros/bubbles-for-android) ⭐ 1,477 | 🐛 28 | 🌐 Java | 📅 2021-01-18 - Facebook like chat bubble library
...
* [NoPaginate](https://github.com/NoNews/NoPaginate) ⭐ 181 | 🐛 6 | 🌐 Java | 📅 2022-01-12 - Simple Android pagination library

#### ActionBar

* [ActionBarSherlock](http://actionbarsherlock.com) - ActionBar for older Android versions.
* [FadingActionBar](https://github.com/ManuelPeinado/FadingActionBar) ⭐ 2,851 | 🐛 85 | 🌐 Java | 📅 2018-05-05 - Fading action bar effect that can be seen in the new Play Music app.

#### Navigation

* [MaterialDrawer](https://github.com/mikepenz/MaterialDrawer) ⭐ 11,654 | 🐛 14 | 🌐 Kotlin | 📅 2026-03-23 - Simple take on a material design navigation drawer.
* [SlidingMenu](https://github.com/jfeinstein10/SlidingMenu) ⭐ 11,025 | 🐛 307 | 🌐 Java | 📅 2021-09-19 - Library to create applications with slide-in menus.
...
* [SlidingTutorial](https://github.com/Cleveroad/slidingtutorial-android) ⭐ 2,460 | 🐛 3 | 🌐 Java | 📅 2018-11-19 - Simple library that helps to create awesome sliding android app tutorials.
...
* [PagerSlidingTabStrip](https://github.com/astuetz/PagerSlidingTabStrip) ⭐ 159 | 🐛 228 | 🌐 Java | 📅 2018-10-06 - An interactive indicator to navigate between the different pages of a ViewPager.
...
* [Android View Animations](https://github.com/daimajia/AndroidViewAnimations) ⭐ 12,473 | 🐛 66 | 🌐 Java | 📅 2021-08-18 - Cute view animation collection.
* [Rebound](https://github.com/facebook/rebound) ⚠️ Archived - Rebound is a Java library that models spring dynamics.
* [Spotlight](https://github.com/TakuSemba/Spotlight) ⭐ 3,662 | 🐛 31 | 🌐 Kotlin | 📅 2022-12-03 - Android Library that lights items for tutorials or walk-throughs etc...
* [Android-Transition](https://github.com/kaichunlin/android-transition) ⭐ 613 | 🐛 3 | 🌐 Java | 📅 2018-05-04 - Allows the easy creation of view transitions that react to user inputs.
...
* [ShapeImageView](https://github.com/siyamed/android-shape-imageview) ⭐ 2,670 | 🐛 63 | 🌐 Java | 📅 2019-07-27 - Library to display images in different shapes.
* [Crescento](https://github.com/developer-shivam/crescento) ⭐ 1,265 | 🐛 9 | 🌐 Java | 📅 2018-10-01 - Explore new style in material design by adding curve below image view.
* [CircularImageView](https://github.com/Pkmmte/CircularImageView) ⭐ 1,174 | 🐛 47 | 🌐 Java | 📅 2017-08-16 - Custom view for circular images while maintaining the best draw performance.
...
* [MaterialEditText](https://github.com/rengwuxian/MaterialEditText) ⭐ 6,099 | 🐛 195 | 🌐 Java | 📅 2019-08-27 - Supporting Floating Labels, Single Line Ellipsis, Max/Min Characters, Helper Text and Error Text with Custom Colors.
* [MaterialSearchBar](https://github.com/mancj/MaterialSearchBar) ⭐ 2,021 | 🐛 84 | 🌐 Java | 📅 2022-07-07 - Material Design Search Bar for Android
...
* [Material Dots Indicators](https://github.com/tommybuonomo/dotsindicator) ⭐ 3,607 | 🐛 27 | 🌐 Kotlin | 📅 2024-11-21 - Three Material Dots Indicators styles for View Pagers.

#### Loading Images

* [Glide](https://github.com/bumptech/glide) ⭐ 35,031 | 🐛 633 | 🌐 Java | 📅 2026-03-25 - An image loading and caching library for Android focused on smooth scrolling, Recommended by Google.
* [Picasso](https://github.com/square/picasso) ⭐ 19,061 | 🐛 214 | 🌐 Kotlin | 📅 2024-11-06 - A powerful image downloading and caching library for Android.
* [Fresco](https://github.com/facebook/fresco) ⭐ 17,163 | 🐛 259 | 🌐 Java | 📅 2026-03-25 - An Android library for managing images and the memory they use.
* [Universal Image Loader](https://github.com/nostra13/Android-Universal-Image-Loader) ⭐ 17,056 | 🐛 460 | 🌐 Java | 📅 2024-08-15 - Asynchronous, out of the box loading and caching of images.
* [Coil](https://github.com/coil-kt/coil) ⭐ 11,746 | 🐛 60 | 🌐 Kotlin | 📅 2026-03-25 - Image loading for Android backed by Kotlin Coroutines.
...
* [ijkplayer](https://github.com/Bilibili/ijkplayer) ⭐ 33,130 | 🐛 2,895 | 🌐 C | 📅 2024-08-13 - Android/iOS video player based on FFmpeg n3.2, with MediaCodec, VideoToolbox support.
* [Exoplayer](https://github.com/google/ExoPlayer) ⭐ 21,935 | 🐛 632 | 🌐 Java | 📅 2025-12-23 - ExoPlayer is an application level media player for Android, allow  playing audio and video both locally and over the Internet.
...
* [Gson](https://github.com/google/gson) ⭐ 24,347 | 🐛 336 | 🌐 Java | 📅 2026-03-19 - Gson is a Java library used for serializing and deserializing Java objects from and into JSON.
* [Moshi](https://github.com/square/moshi) ⭐ 10,120 | 🐛 98 | 🌐 Kotlin | 📅 2026-03-24 - A modern JSON library for Android and Java.
* [Jackson JSON Processor](https://github.com/FasterXML/jackson) ⭐ 9,690 | 🐛 0 | 📅 2026-03-11 - High-performance JSON processor.
...
* [OkHttp](https://github.com/square/okhttp) ⭐ 46,920 | 🐛 90 | 🌐 Kotlin | 📅 2026-03-25 - An HTTP+SPDY client for Android and Java applications.
* [Ion](https://github.com/koush/ion) ⭐ 6,264 | 🐛 337 | 🌐 Java | 📅 2024-02-01 - Good networking library for android.
* [Fast-Android-Networking](https://github.com/amitshekhariitbhu/Fast-Android-Networking) ⭐ 5,890 | 🐛 232 | 🌐 Java | 📅 2026-02-05 - A Complete Fast Android Networking Library that also support HTTP/2.
...
* [RESTMock](https://github.com/andrzejchm/RESTMock) ⭐ 758 | 🐛 5 | 🌐 Java | 📅 2022-07-14 - HTTP Web server for mocking API responses in Android Instrumentation tests.
...
* [logger](https://github.com/orhanobut/logger) ⭐ 13,879 | 🐛 81 | 🌐 Java | 📅 2022-09-14 - Simple, pretty and powerful logger for android
* [timber](https://github.com/JakeWharton/timber) ⭐ 10,810 | 🐛 61 | 🌐 Kotlin | 📅 2026-03-24 - A logger with a small, extensible API which provides utility on top of Android's normal Log class.
* [LoggingInterceptor](https://github.com/ihsanbal/LoggingInterceptor) ⭐ 1,352 | 🐛 0 | 🌐 Kotlin | 📅 2026-02-19 - An OkHttp interceptor which pretty logs request and response data.
* [Logback Android](https://github.com/tony19/logback-android) ⭐ 1,260 | 🐛 37 | 🌐 Java | 📅 2026-01-21 - Logback port to Android which provides a highly configurable logging framework for Android apps.
...
* [android-remote-notifications](https://github.com/kaiwinter/android-remote-notifications) ⭐ 102 | 🐛 1 | 🌐 Java | 📅 2018-06-23 - Pulls notifications from a remote JSON file and shows them in your app.
...
* [Realm](https://github.com/realm/realm-java) ⭐ 11,489 | 🐛 396 | 🌐 Java | 📅 2025-09-15 - The alternative to SQLite and ORMs: Simple, modern and fast! Object oriented API and multi platform support.
* [SQLite Asset Helper](https://github.com/jgilfelt/android-sqlite-asset-helper) ⭐ 2,230 | 🐛 78 | 🌐 Java | 📅 2021-09-23 - manage database creation and version management using an application's raw asset files.
* [DbInspector](https://github.com/infinum/android_dbinspector) ⭐ 956 | 🐛 1 | 🌐 Kotlin | 📅 2026-02-18 - Provides a simple way to view the contents of the in-app database for debugging purposes.
* [Nitrite Database](https://github.com/dizitart/nitrite-database) ⭐ 896 | 🐛 2 | 🌐 Java | 📅 2026-03-24 - A NoSQL embedded document store for Android with MongoDb like API.
...
* [DBFlow](https://github.com/agrosner/DBFlow) ⭐ 4,861 | 🐛 45 | 🌐 Kotlin | 📅 2022-03-15 - Fast and powerful ORM with compile-time annotation processing.
* [requery](https://github.com/requery/requery) ⭐ 3,120 | 🐛 172 | 🌐 Java | 📅 2026-02-09 - Compile time ORM and SQL query library for Java & Android.
* [SimpleNoSQL](https://github.com/Jearil/SimpleNoSQL) ⭐ 388 | 🐛 16 | 🌐 Java | 📅 2020-10-26 - A simple NoSQL client for Android. Meant as a document store using key/value pairs and some rudimentary querying. Useful for avoiding the hassle of SQL code.
...
* [Android Maps Extensions](https://github.com/mg6maciej/android-maps-extensions) ⭐ 413 | 🐛 11 | 🌐 Java | 📅 2021-06-05 - Extending capabilities of Google Maps Android API v2, adding marker clustering among other things
...
* [LeakCanary](https://github.com/square/leakcanary) ⭐ 29,919 | 🐛 153 | 🌐 Kotlin | 📅 2026-03-24 - Catch memory leaks as they occur.
* [Otto](https://github.com/square/otto) ⚠️ Archived - Event Bus for Android.
* [EasyDeviceInfo](https://github.com/nisrulz/easydeviceinfo) ⭐ 1,786 | 🐛 10 | 🌐 Java | 📅 2024-07-12 - Get device information in a super easy way.
* [Weak handler](https://github.com/badoo/android-weak-handler) ⭐ 1,542 | 🐛 5 | 🌐 Java | 📅 2022-02-24 - Memory safer implementation of android.os.Handler.
...
* [Keyboard Visibility Event](https://github.com/viniciusmo/keyboard-visibility-event-android/) ⭐ 20 | 🐛 3 | 🌐 Kotlin | 📅 2021-09-28 - A DSL to handle soft keyboard visibility change event.
...
* [Stetho](https://github.com/facebook/stetho) ⭐ 12,701 | 🐛 85 | 🌐 Java | 📅 2024-10-26 - Debug hierarchy and network from chrome.
* [Android Debug Bridge - ADB](https://github.com/mzlogin/awesome-adb/blob/master/README.en.md) ⭐ 12,258 | 🐛 50 | 📅 2024-12-18 - a command-line tool to assist in debugging Android-powered devices
* [Android Debug Database](https://github.com/amitshekhariitbhu/Android-Debug-Database) ⭐ 8,645 | 🐛 82 | 🌐 Java | 📅 2026-02-05 - Android Debug Database is a powerful library for debugging databases and shared preferences in Android applications.
* [Pidcat](https://github.com/JakeWharton/pidcat) ⭐ 4,943 | 🐛 67 | 🌐 Python | 📅 2024-05-10 - a colored command-line ADB wrapper that only shows log entries for a specific application package
* [Scalpel](https://github.com/JakeWharton/scalpel) ⚠️ Archived - View the entire hierarchy in 3d in the phone.
* [ADB Enhanced](https://github.com/ashishb/adb-enhanced) ⭐ 1,366 | 🐛 0 | 🌐 Python | 📅 2026-03-20 - a command-line wrapper around ADB for developers, so that, developers don't have to remember esoteric version-dependent commands
...
* [Qiscus SDK](https://github.com/qiscus/qiscus-sdk-android) ⭐ 203 | 🐛 0 | 🌐 Java | 📅 2026-03-10 - Qiscus SDK is a lightweight and powerful android chat library. Qiscus SDK will allow you to easily integrating Qiscus engine with your apps to make cool chatting application.
* [Kommunicate Live Chat SDK](https://github.com/Kommunicate-io/Kommunicate-Android-Chat-SDK) ⭐ 79 | 🐛 1 | 🌐 Java | 📅 2026-03-24 - Kommunicate provides open source live chat sdk in android. Kommunicate lets you add real time live chat and in-app messaging in your mobile (android, iOS) applications and website for customer support.
...
* [HijriDatePicker](https://github.com/alhazmy13/HijriDatePicker) ⭐ 146 | 🐛 13 | 🌐 Java | 📅 2022-11-27 - offers a hijri (Islamic Calendar) Date Picker designed on Google's Material Design Principals For Pickers.
...
* [Joda-Time Android](https://github.com/dlew/joda-time-android) ⭐ 2,629 | 🐛 3 | 🌐 Java | 📅 2026-03-09 - Joda-Time library with Android specialization.
* [True Time](https://github.com/instacart/truetime-android) ⭐ 1,477 | 🐛 41 | 🌐 Kotlin | 📅 2023-06-12 - Android NTP time library. Get the true current time impervious to device clock time changes.

### Runtime Permissions

* [Permission Dispatcher](https://github.com/permissions-dispatcher/PermissionsDispatcher) ⭐ 11,204 | 🐛 32 | 🌐 Java | 📅 2023-11-10 - Simple annotation-based API to handle runtime permissions.
...
* [Guava: Google Core Libraries for Java](https://github.com/google/guava) ⭐ 51,504 | 🐛 725 | 🌐 Java | 📅 2026-03-23 - Collections, caching, primitives support, concurrency libraries, common annotations, string processing, I/O, and so forth.
* [RxJava](https://github.com/ReactiveX/RxJava) ⭐ 48,469 | 🐛 16 | 🌐 Java | 📅 2026-03-25- RxJava – Reactive Extensions for the JVM – a library for composing asynchronous and event-based programs using observable sequences for the Java VM.
* [ZXing Android-Integration](https://github.com/zxing/zxing) ⭐ 33,901 | 🐛 10 | 🌐 Java | 📅 2026-03-16 - Integration with Barcode Scanner via Intent.
* [RxAndroid](https://github.com/ReactiveX/RxAndroid) ⭐ 20,181 | 🐛 1 | 🌐 Java | 📅 2026-03-24 - Adds minimum RxJava bindings for easy writing of reactive Android java code.
...
* [Gradle Retrolambda Plugin](https://github.com/evant/gradle-retrolambda) ⭐ 5,283 | 🐛 76 | 🌐 Java | 📅 2023-07-24 - Java 8 Lambdas on Android!
* [AboutLibraries](https://github.com/mikepenz/AboutLibraries) ⭐ 4,248 | 🐛 11 | 🌐 Kotlin | 📅 2026-03-23 - Automatically generates an About this app section, with a list of used libraries.
* [Android Priority Job Queue](https://github.com/yigit/android-priority-jobqueue) ⭐ 3,382 | 🐛 140 | 🌐 Java | 📅 2022-10-22 - Implementation of a Job Queue to easily schedule jobs (tasks) that run in the background, improving UX and application stability.
...
* [Gradle buildSrcVersions](https://github.com/jmfayard/buildSrcVersions) ⭐ 1,702 | 🐛 130 | 🌐 Kotlin | 📅 2025-08-16 - A kotlin dsl to simplify dependencies management
* [Licensee](https://github.com/cashapp/licensee) ⭐ 741 | 🐛 32 | 🌐 Kotlin | 📅 2026-03-24 - Licensee is a Gradle plugin which validates the licenses of your dependency graph match what you expect, or it fails your build!
...
* [Caffeine](https://github.com/percolate/caffeine) ⭐ 415 | 🐛 2 | 🌐 Java | 📅 2017-03-14 - A collection of utility classes that help make Android development faster.
...
* [Android Architecture Blueprints](https://github.com/android/architecture-samples) ⭐ 45,616 | 🐛 217 | 🌐 Kotlin | 📅 2026-03-25 - The Android Architecture Blueprints project demonstrates strategies to help solve or avoid common android problems.
* [Android Modular Architecture](https://github.com/VMadalin/kotlin-sample-app) ⭐ 2,442 | 🐛 4 | 🌐 Kotlin | 📅 2021-08-23 - Android Sample App using modular, clean, scalable, testable Architecture written in Kotlin following the best practices with Jetpack.
...
* [React Native](https://github.com/facebook/react-native) ⭐ 125,639 | 🐛 1,260 | 🌐 C++ | 📅 2026-03-25 - A framework for building native apps with React by Facebook.
* [Capacitor](https://github.com/ionic-team/capacitor) ⭐ 15,337 | 🐛 104 | 🌐 TypeScript | 📅 2026-03-25 - Build cross-platform Native Progressive Web Apps for iOS, Android, and the web. Very promising Cordova alternative.
* [Apache Cordova](https://github.com/apache/cordova-android) ⭐ 3,780 | 🐛 93 | 🌐 JavaScript | 📅 2026-03-25 - Cordova based applications are, at the core, applications written with web technology: HTML, CSS and JavaScript.
...
* [Kotlin coding puzzles](https://github.com/igorwojda/kotlin-coding-puzzle) ⭐ 1,048 | 🐛 16 | 🌐 Kotlin | 📅 2026-03-19 - Set of programming challenges thats helps to improve whiteboard coding and problem-solving skills.
...
* [AppDimens](https://github.com/bodenberg/appdimens) ⭐ 13 | 🐛 7 | 🌐 Kotlin | 📅 2026-03-22 - Smart Responsive Dimensions for Any Screen (FX, DY, DP, SP, Logarithmic)
...
* [Booster](https://github.com/didi/booster) ⭐ 5,063 | 🐛 52 | 🌐 Kotlin | 📅 2026-03-15 - Booster is an optimization toolkit for Android applications.
...
Other amazingly awesome lists can be found in the [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,307 | 🐛 49 | 🌐 Ruby | 📅 2024-06-02 list.
