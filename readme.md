...
[<img src="https://raw.githubusercontent.com/jstumpp/awesome-android/master/awesome-android.png">](https://github.com/jstumpp/awesome-android) ⭐ 12,013 | 🐛 69 | 📅 2025-10-27
...
A curated list of awesome Android [libraries](#libraries) and [resources](#resources). For general Java libraries have a look at [awesome-java](https://github.com/akullpp/awesome-java) ⭐ 47,394 | 🐛 21 | 📅 2026-02-07.
...
* [MPAndroidChart](https://github.com/PhilJay/MPAndroidChart) ⭐ 38,229 | 🐛 2,189 | 🌐 Java | 📅 2025-06-05 - An Android chart and graph library supporting scaling and dragging by gesture.
* [HelloCharts](https://github.com/lecho/hellocharts-android) ⭐ 7,796 | 🐛 293 | 🌐 Java | 📅 2021-06-01 - Chart and graph library with support for scaling, scrolling and animations.
* [WilliamChart](https://github.com/diogobernardino/WilliamChart) ⭐ 5,112 | 🐛 35 | 🌐 Kotlin | 📅 2025-10-04 - Chart library with good motion capabilities.
...
* [Dagger 2](https://github.com/google/dagger) ⭐ 17,709 | 🐛 365 | 🌐 Java | 📅 2026-03-13 - A fast dependency injector for Android and Java.
...
* [Libgdx](https://libgdx.badlogicgames.com/) - Cross-platform game engine and SDK. [Open Source](https://github.com/libGDX/libGDX) ⭐ 24,944 | 🐛 331 | 🌐 Java | 📅 2026-02-27
...
* [FloatingView](https://github.com/UFreedom/FloatingView) ⭐ 1,810 | 🐛 3 | 🌐 Java | 📅 2019-05-24 - FloatingView can make the target view floating above the anchor view with cool animation.
...
* [MaterialDrawer](https://github.com/mikepenz/MaterialDrawer) ⭐ 11,655 | 🐛 14 | 🌐 Kotlin | 📅 2026-03-23 - Simple take on a material design navigation drawer.
...
* [Crescento](https://github.com/developer-shivam/crescento) ⭐ 1,266 | 🐛 9 | 🌐 Java | 📅 2018-10-01 - Explore new style in material design by adding curve below image view.
...
* [Material Dots Indicators](https://github.com/tommybuonomo/dotsindicator) ⭐ 3,608 | 🐛 27 | 🌐 Kotlin | 📅 2024-11-21 - Three Material Dots Indicators styles for View Pagers.

#### Loading Images

* [Glide](https://github.com/bumptech/glide) ⭐ 35,032 | 🐛 633 | 🌐 Java | 📅 2026-03-11 - An image loading and caching library for Android focused on smooth scrolling, Recommended by Google.
...
* [Coil](https://github.com/coil-kt/coil) ⭐ 11,744 | 🐛 59 | 🌐 Kotlin | 📅 2026-03-24 - Image loading for Android backed by Kotlin Coroutines.
...
* [Gson](https://github.com/google/gson) ⭐ 24,345 | 🐛 332 | 🌐 Java | 📅 2026-03-19 - Gson is a Java library used for serializing and deserializing Java objects from and into JSON.
* [Moshi](https://github.com/square/moshi) ⭐ 10,119 | 🐛 98 | 🌐 Kotlin | 📅 2026-03-24 - A modern JSON library for Android and Java.
* [Jackson JSON Processor](https://github.com/FasterXML/jackson) ⭐ 9,689 | 🐛 0 | 📅 2026-03-11 - High-performance JSON processor.
...
* [OkHttp](https://github.com/square/okhttp) ⭐ 46,922 | 🐛 90 | 🌐 Kotlin | 📅 2026-03-23 - An HTTP+SPDY client for Android and Java applications.
* [Ion](https://github.com/koush/ion) ⭐ 6,265 | 🐛 337 | 🌐 Java | 📅 2024-02-01 - Good networking library for android.
...
* [Android Debug Bridge - ADB](https://github.com/mzlogin/awesome-adb/blob/master/README.en.md) ⭐ 12,255 | 🐛 50 | 📅 2024-12-18 - a command-line tool to assist in debugging Android-powered devices
...
* [Joda-Time Android](https://github.com/dlew/joda-time-android) ⭐ 2,630 | 🐛 3 | 🌐 Java | 📅 2026-03-09 - Joda-Time library with Android specialization.
...
* [Guava: Google Core Libraries for Java](https://github.com/google/guava) ⭐ 51,502 | 🐛 723 | 🌐 Java | 📅 2026-03-23 - Collections, caching, primitives support, concurrency libraries, common annotations, string processing, I/O, and so forth.
* [RxJava](https://github.com/ReactiveX/RxJava) ⭐ 48,470 | 🐛 14 | 🌐 Java | 📅 2026-03-24- RxJava – Reactive Extensions for the JVM – a library for composing asynchronous and event-based programs using observable sequences for the Java VM.
* [ZXing Android-Integration](https://github.com/zxing/zxing) ⭐ 33,900 | 🐛 10 | 🌐 Java | 📅 2026-03-16 - Integration with Barcode Scanner via Intent.
...
* [Flexbox Layout](https://github.com/google/flexbox-layout) ⭐ 18,355 | 🐛 133 | 🌐 Kotlin | 📅 2024-04-22 - FlexboxLayout is a library which brings the similar capabilities of CSS Flexible Box Layout Module to Android. 
...
* [AboutLibraries](https://github.com/mikepenz/AboutLibraries) ⭐ 4,247 | 🐛 11 | 🌐 Kotlin | 📅 2026-03-23 - Automatically generates an About this app section, with a list of used libraries.
...
* [Android Architecture Blueprints](https://github.com/android/architecture-samples) ⭐ 45,619 | 🐛 217 | 🌐 Kotlin | 📅 2026-03-25 - The Android Architecture Blueprints project demonstrates strategies to help solve or avoid common android problems.
* [Android Modular Architecture](https://github.com/VMadalin/kotlin-sample-app) ⭐ 2,443 | 🐛 4 | 🌐 Kotlin | 📅 2021-08-23 - Android Sample App using modular, clean, scalable, testable Architecture written in Kotlin following the best practices with Jetpack.
...
* [React Native](https://github.com/facebook/react-native) ⭐ 125,636 | 🐛 1,253 | 🌐 C++ | 📅 2026-03-25 - A framework for building native apps with React by Facebook.
* [Capacitor](https://github.com/ionic-team/capacitor) ⭐ 15,329 | 🐛 107 | 🌐 TypeScript | 📅 2026-03-24 - Build cross-platform Native Progressive Web Apps for iOS, Android, and the web. Very promising Cordova alternative.
* [Apache Cordova](https://github.com/apache/cordova-android) ⭐ 3,780 | 🐛 93 | 🌐 JavaScript | 📅 2026-03-23 - Cordova based applications are, at the core, applications written with web technology: HTML, CSS and JavaScript.
