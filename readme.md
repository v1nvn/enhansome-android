...
[<img src="https://raw.githubusercontent.com/jstumpp/awesome-android/master/awesome-android.png">](https://github.com/jstumpp/awesome-android) ⭐ 11,994 | 🐛 67 | 📅 2025-10-27
...
A curated list of awesome Android [libraries](#libraries) and [resources](#resources). For general Java libraries have a look at [awesome-java](https://github.com/akullpp/awesome-java) ⭐ 47,333 | 🐛 18 | 📅 2026-02-07.
...
* [Dagger 2](https://github.com/google/dagger) ⭐ 17,708 | 🐛 365 | 🌐 Java | 📅 2026-03-13 - A fast dependency injector for Android and Java.
...
* [Remoter](https://github.com/josesamuel/remoter) ⭐ 94 | 🐛 1 | 🌐 Kotlin | 📅 2025-12-18 - An alternative to Android AIDL for Android Remote IPC services using plain java interfaces.
...
* [Libgdx](https://libgdx.badlogicgames.com/) - Cross-platform game engine and SDK. [Open Source](https://github.com/libGDX/libGDX) ⭐ 24,914 | 🐛 329 | 🌐 Java | 📅 2026-02-27
...
* [Themis](https://github.com/cossacklabs/themis) ⭐ 1,953 | 🐛 32 | 🌐 C | 📅 2026-01-09 - Multi-language framework for making typical encryption schemes easy to use: data at rest, authenticated data exchange, transport protection, authentication, and so on.
...
* [Litho (By Facebook)](https://github.com/facebook/litho) ⭐ 7,781 | 🐛 110 | 🌐 Kotlin | 📅 2026-03-16 - A declarative framework for building efficient UIs on Android.
...
* [Cardslib](https://github.com/gabrielemariotti/cardslib) ⭐ 4,633 | 🐛 183 | 🌐 Java | 📅 2021-11-18 - Android Library to build a UI Card.
...
* [MaterialDrawer](https://github.com/mikepenz/MaterialDrawer) ⭐ 11,650 | 🐛 14 | 🌐 Kotlin | 📅 2026-03-17 - Simple take on a material design navigation drawer.
...
* [ShapeImageView](https://github.com/siyamed/android-shape-imageview) ⭐ 2,671 | 🐛 63 | 🌐 Java | 📅 2019-07-27 - Library to display images in different shapes.
...
* [Material Dots Indicators](https://github.com/tommybuonomo/dotsindicator) ⭐ 3,611 | 🐛 27 | 🌐 Kotlin | 📅 2024-11-21 - Three Material Dots Indicators styles for View Pagers.

#### Loading Images

* [Glide](https://github.com/bumptech/glide) ⭐ 35,033 | 🐛 633 | 🌐 Java | 📅 2026-03-11 - An image loading and caching library for Android focused on smooth scrolling, Recommended by Google.
* [Picasso](https://github.com/square/picasso) ⭐ 19,065 | 🐛 213 | 🌐 Kotlin | 📅 2024-11-06 - A powerful image downloading and caching library for Android.
* [Fresco](https://github.com/facebook/fresco) ⭐ 17,164 | 🐛 260 | 🌐 Java | 📅 2026-03-16 - An Android library for managing images and the memory they use.
* [Universal Image Loader](https://github.com/nostra13/Android-Universal-Image-Loader) ⭐ 17,061 | 🐛 460 | 🌐 Java | 📅 2024-08-15 - Asynchronous, out of the box loading and caching of images.
* [Coil](https://github.com/coil-kt/coil) ⭐ 11,740 | 🐛 60 | 🌐 Kotlin | 📅 2026-03-16 - Image loading for Android backed by Kotlin Coroutines.
...
* [ijkplayer](https://github.com/Bilibili/ijkplayer) ⭐ 33,122 | 🐛 2,895 | 🌐 C | 📅 2024-08-13 - Android/iOS video player based on FFmpeg n3.2, with MediaCodec, VideoToolbox support.
...
* [MagicalCamera](https://github.com/fabian7593/MagicalCamera) ⭐ 339 | 🐛 8 | 🌐 Java | 📅 2019-02-27 - Simple way to take or select photos of your gallery, with other features for manage pictures.
...
* [Gson](https://github.com/google/gson) ⭐ 24,344 | 🐛 334 | 🌐 Java | 📅 2026-03-10 - Gson is a Java library used for serializing and deserializing Java objects from and into JSON.
* [Moshi](https://github.com/square/moshi) ⭐ 10,121 | 🐛 98 | 🌐 Kotlin | 📅 2026-03-17 - A modern JSON library for Android and Java.
* [Jackson JSON Processor](https://github.com/FasterXML/jackson) ⭐ 9,684 | 🐛 0 | 📅 2026-03-11 - High-performance JSON processor.
...
* [OkHttp](https://github.com/square/okhttp) ⭐ 46,925 | 🐛 92 | 🌐 Kotlin | 📅 2026-03-18 - An HTTP+SPDY client for Android and Java applications.
* [Ion](https://github.com/koush/ion) ⭐ 6,266 | 🐛 337 | 🌐 Java | 📅 2024-02-01 - Good networking library for android.
...
* [logger](https://github.com/orhanobut/logger) ⭐ 13,877 | 🐛 81 | 🌐 Java | 📅 2022-09-14 - Simple, pretty and powerful logger for android
* [timber](https://github.com/JakeWharton/timber) ⭐ 10,806 | 🐛 61 | 🌐 Kotlin | 📅 2026-03-17 - A logger with a small, extensible API which provides utility on top of Android's normal Log class.
* [LoggingInterceptor](https://github.com/ihsanbal/LoggingInterceptor) ⭐ 1,350 | 🐛 0 | 🌐 Kotlin | 📅 2026-02-19 - An OkHttp interceptor which pretty logs request and response data.
...
* [Realm](https://github.com/realm/realm-java) ⭐ 11,492 | 🐛 396 | 🌐 Java | 📅 2025-09-15 - The alternative to SQLite and ORMs: Simple, modern and fast! Object oriented API and multi platform support.
* [SQLite Asset Helper](https://github.com/jgilfelt/android-sqlite-asset-helper) ⭐ 2,231 | 🐛 78 | 🌐 Java | 📅 2021-09-23 - manage database creation and version management using an application's raw asset files.
...
* [Nitrite Database](https://github.com/dizitart/nitrite-database) ⭐ 896 | 🐛 3 | 🌐 Java | 📅 2026-03-17 - A NoSQL embedded document store for Android with MongoDb like API.
...
* [LeakCanary](https://github.com/square/leakcanary) ⭐ 29,912 | 🐛 154 | 🌐 Kotlin | 📅 2026-03-06 - Catch memory leaks as they occur.
...
* [Stetho](https://github.com/facebook/stetho) ⭐ 12,705 | 🐛 85 | 🌐 Java | 📅 2024-10-26 - Debug hierarchy and network from chrome.
* [Android Debug Bridge - ADB](https://github.com/mzlogin/awesome-adb/blob/master/README.en.md) ⭐ 12,248 | 🐛 50 | 📅 2024-12-18 - a command-line tool to assist in debugging Android-powered devices
...
* [ADB Enhanced](https://github.com/ashishb/adb-enhanced) ⭐ 1,366 | 🐛 0 | 🌐 Python | 📅 2026-03-14 - a command-line wrapper around ADB for developers, so that, developers don't have to remember esoteric version-dependent commands
...
* [SmartGattLib](https://github.com/movisens/SmartGattLib) ⭐ 284 | 🐛 1 | 🌐 Java | 📅 2023-11-23 - Simplifies the work with Bluetooth SMART devices (a.k.a. Bluetooth Low Energy in Bluetooth 4.0).
...
* [Permission Dispatcher](https://github.com/permissions-dispatcher/PermissionsDispatcher) ⭐ 11,205 | 🐛 32 | 🌐 Java | 📅 2023-11-10 - Simple annotation-based API to handle runtime permissions.
...
* [Ask-Permission](https://github.com/Kishanjvaghela/Ask-Permission) ⭐ 77 | 🐛 8 | 🌐 Java | 📅 2018-11-07 - Simple RunTime permission manager.
...
* [Guava: Google Core Libraries for Java](https://github.com/google/guava) ⭐ 51,503 | 🐛 722 | 🌐 Java | 📅 2026-03-17 - Collections, caching, primitives support, concurrency libraries, common annotations, string processing, I/O, and so forth.
* [RxJava](https://github.com/ReactiveX/RxJava) ⭐ 48,485 | 🐛 23 | 🌐 Java | 📅 2026-03-17- RxJava – Reactive Extensions for the JVM – a library for composing asynchronous and event-based programs using observable sequences for the Java VM.
* [ZXing Android-Integration](https://github.com/zxing/zxing) ⭐ 33,886 | 🐛 10 | 🌐 Java | 📅 2026-03-16 - Integration with Barcode Scanner via Intent.
* [RxAndroid](https://github.com/ReactiveX/RxAndroid) ⭐ 20,181 | 🐛 1 | 🌐 Java | 📅 2025-11-21 - Adds minimum RxJava bindings for easy writing of reactive Android java code.
...
* [AboutLibraries](https://github.com/mikepenz/AboutLibraries) ⭐ 4,243 | 🐛 10 | 🌐 Kotlin | 📅 2026-03-17 - Automatically generates an About this app section, with a list of used libraries.
...
* [Gradle buildSrcVersions](https://github.com/jmfayard/buildSrcVersions) ⭐ 1,701 | 🐛 130 | 🌐 Kotlin | 📅 2025-08-16 - A kotlin dsl to simplify dependencies management
* [Licensee](https://github.com/cashapp/licensee) ⭐ 741 | 🐛 31 | 🌐 Kotlin | 📅 2026-03-17 - Licensee is a Gradle plugin which validates the licenses of your dependency graph match what you expect, or it fails your build!
...
* [Teller](https://github.com/levibostian/Teller-Android/) ⭐ 18 | 🐛 25 | 🌐 Kotlin | 📅 2022-02-25 - Teller facilitates the downloading, saving, and reading of the cached data of your app. Keep your user's data fresh and remove those annoying loading screens!
...
* [Android Architecture Blueprints](https://github.com/android/architecture-samples) ⭐ 45,612 | 🐛 217 | 🌐 Kotlin | 📅 2026-03-16 - The Android Architecture Blueprints project demonstrates strategies to help solve or avoid common android problems.
...
* [React Native](https://github.com/facebook/react-native) ⭐ 125,610 | 🐛 1,267 | 🌐 C++ | 📅 2026-03-18 - A framework for building native apps with React by Facebook.
* [Capacitor](https://github.com/ionic-team/capacitor) ⭐ 15,275 | 🐛 111 | 🌐 TypeScript | 📅 2026-03-17 - Build cross-platform Native Progressive Web Apps for iOS, Android, and the web. Very promising Cordova alternative.
* [Apache Cordova](https://github.com/apache/cordova-android) ⭐ 3,780 | 🐛 94 | 🌐 JavaScript | 📅 2026-03-13 - Cordova based applications are, at the core, applications written with web technology: HTML, CSS and JavaScript.
...
* [Kotlin coding puzzles](https://github.com/igorwojda/kotlin-coding-puzzle) ⭐ 1,049 | 🐛 16 | 🌐 Kotlin | 📅 2026-03-16 - Set of programming challenges thats helps to improve whiteboard coding and problem-solving skills.
...
* [AppDimens](https://github.com/bodenberg/appdimens) ⭐ 12 | 🐛 7 | 🌐 Kotlin | 📅 2026-03-13 - Smart Responsive Dimensions for Any Screen (FX, DY, DP, SP, Logarithmic)
...
Other amazingly awesome lists can be found in the [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,285 | 🐛 46 | 🌐 Ruby | 📅 2024-06-02 list.
