...
[<img src="https://raw.githubusercontent.com/jstumpp/awesome-android/master/awesome-android.png">](https://github.com/jstumpp/awesome-android) ⭐ 12,073 | 🐛 69 | 📅 2025-10-27
...
A curated list of awesome Android [libraries](#libraries) and [resources](#resources). For general Java libraries have a look at [awesome-java](https://github.com/akullpp/awesome-java) ⭐ 47,701 | 🐛 4 | 📅 2026-04-12.
...
* [HelloCharts](https://github.com/lecho/hellocharts-android) ⭐ 7,653 | 🐛 293 | 🌐 Java | 📅 2021-06-01 - Chart and graph library with support for scaling, scrolling and animations.
...
* [AnyChart](https://github.com/AnyChart/AnyChart-Android) ⭐ 2,373 | 🐛 115 | 🌐 Java | 📅 2026-03-13 - Data visualization library, Interactive charts.
* [EazeGraph](https://github.com/blackfizz/EazeGraph) ⭐ 1,594 | 🐛 52 | 🌐 Java | 📅 2016-11-11 - Chart and graph library.
...
* [Dagger 2](https://github.com/google/dagger) ⭐ 17,702 | 🐛 358 | 🌐 Java | 📅 2026-04-21 - A fast dependency injector for Android and Java.
...
* [Libgdx](https://libgdx.badlogicgames.com/) - Cross-platform game engine and SDK. [Open Source](https://github.com/libGDX/libGDX) ⭐ 25,023 | 🐛 329 | 🌐 Java | 📅 2026-04-19
...
* [Litho (By Facebook)](https://github.com/facebook/litho) ⭐ 7,772 | 🐛 116 | 🌐 Kotlin | 📅 2026-04-20 - A declarative framework for building efficient UIs on Android.
...
* [Cardslib](https://github.com/gabrielemariotti/cardslib) ⭐ 4,627 | 🐛 183 | 🌐 Java | 📅 2021-11-18 - Android Library to build a UI Card.
...
* [ShimmerLayout](https://github.com/team-supercharge/ShimmerLayout) ⭐ 2,519 | 🐛 18 | 🌐 Java | 📅 2020-03-26 - Memory efficient shimmering effect for Android applications.
...
* [MaterialDrawer](https://github.com/mikepenz/MaterialDrawer) ⭐ 11,651 | 🐛 11 | 🌐 Kotlin | 📅 2026-04-14 - Simple take on a material design navigation drawer.
* [SlidingMenu](https://github.com/jfeinstein10/SlidingMenu) ⭐ 11,018 | 🐛 306 | 🌐 Java | 📅 2021-09-19 - Library to create applications with slide-in menus.
...
* [SlidingTutorial](https://github.com/Cleveroad/slidingtutorial-android) ⭐ 2,458 | 🐛 3 | 🌐 Java | 📅 2018-11-19 - Simple library that helps to create awesome sliding android app tutorials.
...
* [ShapeImageView](https://github.com/siyamed/android-shape-imageview) ⭐ 2,659 | 🐛 63 | 🌐 Java | 📅 2019-07-27 - Library to display images in different shapes.
...
* [Glide](https://github.com/bumptech/glide) ⭐ 35,023 | 🐛 635 | 🌐 Java | 📅 2026-04-20 - An image loading and caching library for Android focused on smooth scrolling, Recommended by Google.
* [Picasso](https://github.com/square/picasso) ⭐ 18,909 | 🐛 214 | 🌐 Kotlin | 📅 2024-11-06 - A powerful image downloading and caching library for Android.
* [Fresco](https://github.com/facebook/fresco) ⭐ 17,149 | 🐛 259 | 🌐 Java | 📅 2026-04-21 - An Android library for managing images and the memory they use.
* [Universal Image Loader](https://github.com/nostra13/Android-Universal-Image-Loader) ⭐ 16,919 | 🐛 459 | 🌐 Java | 📅 2024-08-15 - Asynchronous, out of the box loading and caching of images.
* [Coil](https://github.com/coil-kt/coil) ⭐ 11,765 | 🐛 65 | 🌐 Kotlin | 📅 2026-04-21 - Image loading for Android backed by Kotlin Coroutines.
...
* [ijkplayer](https://github.com/Bilibili/ijkplayer) ⭐ 33,144 | 🐛 2,895 | 🌐 C | 📅 2024-08-13 - Android/iOS video player based on FFmpeg n3.2, with MediaCodec, VideoToolbox support.
* [Exoplayer](https://github.com/google/ExoPlayer) ⭐ 21,914 | 🐛 632 | 🌐 Java | 📅 2025-12-23 - ExoPlayer is an application level media player for Android, allow  playing audio and video both locally and over the Internet.
...
* [Gson](https://github.com/google/gson) ⭐ 24,235 | 🐛 341 | 🌐 Java | 📅 2026-04-17 - Gson is a Java library used for serializing and deserializing Java objects from and into JSON.
* [Moshi](https://github.com/square/moshi) ⭐ 10,127 | 🐛 98 | 🌐 Kotlin | 📅 2026-04-12 - A modern JSON library for Android and Java.
* [Jackson JSON Processor](https://github.com/FasterXML/jackson) ⭐ 9,706 | 🐛 0 | 📅 2026-04-19 - High-performance JSON processor.
...
* [OkHttp](https://github.com/square/okhttp) ⭐ 46,932 | 🐛 100 | 🌐 Kotlin | 📅 2026-04-21 - An HTTP+SPDY client for Android and Java applications.
...
* [timber](https://github.com/JakeWharton/timber) ⭐ 10,814 | 🐛 62 | 🌐 Kotlin | 📅 2026-04-21 - A logger with a small, extensible API which provides utility on top of Android's normal Log class.
...
* [Realm](https://github.com/realm/realm-java) ⭐ 11,480 | 🐛 396 | 🌐 Java | 📅 2025-09-15 - The alternative to SQLite and ORMs: Simple, modern and fast! Object oriented API and multi platform support.
...
* [DbInspector](https://github.com/infinum/android_dbinspector) ⭐ 953 | 🐛 1 | 🌐 Kotlin | 📅 2026-04-20 - Provides a simple way to view the contents of the in-app database for debugging purposes.
* [Nitrite Database](https://github.com/dizitart/nitrite-database) ⭐ 901 | 🐛 7 | 🌐 Java | 📅 2026-04-20 - A NoSQL embedded document store for Android with MongoDb like API.
...
* [requery](https://github.com/requery/requery) ⭐ 3,123 | 🐛 171 | 🌐 Java | 📅 2026-02-09 - Compile time ORM and SQL query library for Java & Android.
...
* [LeakCanary](https://github.com/square/leakcanary) ⭐ 29,925 | 🐛 159 | 🌐 Kotlin | 📅 2026-03-24 - Catch memory leaks as they occur.
...
* [Weak handler](https://github.com/badoo/android-weak-handler) ⭐ 1,539 | 🐛 5 | 🌐 Java | 📅 2022-02-24 - Memory safer implementation of android.os.Handler.
...
* [Android Debug Bridge - ADB](https://github.com/mzlogin/awesome-adb/blob/master/README.en.md) ⭐ 12,286 | 🐛 50 | 📅 2024-12-18 - a command-line tool to assist in debugging Android-powered devices
...
* [ADB Enhanced](https://github.com/ashishb/adb-enhanced) ⭐ 1,370 | 🐛 0 | 🌐 Python | 📅 2026-04-17 - a command-line wrapper around ADB for developers, so that, developers don't have to remember esoteric version-dependent commands
...
* [Guava: Google Core Libraries for Java](https://github.com/google/guava) ⭐ 51,496 | 🐛 728 | 🌐 Java | 📅 2026-04-21 - Collections, caching, primitives support, concurrency libraries, common annotations, string processing, I/O, and so forth.
* [RxJava](https://github.com/ReactiveX/RxJava) ⭐ 48,325 | 🐛 21 | 🌐 Java | 📅 2026-04-16- RxJava – Reactive Extensions for the JVM – a library for composing asynchronous and event-based programs using observable sequences for the Java VM.
* [ZXing Android-Integration](https://github.com/zxing/zxing) ⭐ 33,920 | 🐛 5 | 🌐 Java | 📅 2026-04-20 - Integration with Barcode Scanner via Intent.
* [RxAndroid](https://github.com/ReactiveX/RxAndroid) ⭐ 20,039 | 🐛 1 | 🌐 Java | 📅 2026-03-24 - Adds minimum RxJava bindings for easy writing of reactive Android java code.
...
* [AboutLibraries](https://github.com/mikepenz/AboutLibraries) ⭐ 4,265 | 🐛 5 | 🌐 Kotlin | 📅 2026-04-21 - Automatically generates an About this app section, with a list of used libraries.
...
* [Licensee](https://github.com/cashapp/licensee) ⭐ 746 | 🐛 33 | 🌐 Kotlin | 📅 2026-04-21 - Licensee is a Gradle plugin which validates the licenses of your dependency graph match what you expect, or it fails your build!
...
* [Android Architecture Blueprints](https://github.com/android/architecture-samples) ⭐ 45,652 | 🐛 219 | 🌐 Kotlin | 📅 2026-04-21 - The Android Architecture Blueprints project demonstrates strategies to help solve or avoid common android problems.
...
* [React Native](https://github.com/facebook/react-native) ⭐ 125,736 | 🐛 1,289 | 🌐 C++ | 📅 2026-04-22 - A framework for building native apps with React by Facebook.
* [Capacitor](https://github.com/ionic-team/capacitor) ⭐ 15,502 | 🐛 111 | 🌐 TypeScript | 📅 2026-04-21 - Build cross-platform Native Progressive Web Apps for iOS, Android, and the web. Very promising Cordova alternative.
* [Apache Cordova](https://github.com/apache/cordova-android) ⭐ 3,779 | 🐛 89 | 🌐 JavaScript | 📅 2026-04-20 - Cordova based applications are, at the core, applications written with web technology: HTML, CSS and JavaScript.
...
* [Kotlin coding puzzles](https://github.com/igorwojda/kotlin-coding-puzzle) ⭐ 1,050 | 🐛 16 | 🌐 Kotlin | 📅 2026-03-19 - Set of programming challenges thats helps to improve whiteboard coding and problem-solving skills.
...
Other amazingly awesome lists can be found in the [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,377 | 🐛 52 | 🌐 Ruby | 📅 2024-06-02 list.
