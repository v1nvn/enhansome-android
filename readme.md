...
[<img src="https://raw.githubusercontent.com/jstumpp/awesome-android/master/awesome-android.png">](https://github.com/jstumpp/awesome-android) ⭐ 11,931 | 🐛 65 | 📅 2025-10-27
...
A curated list of awesome Android [libraries](#libraries) and [resources](#resources). For general Java libraries have a look at [awesome-java](https://github.com/akullpp/awesome-java) ⭐ 47,009 | 🐛 3 | 📅 2026-02-07.
...
* [MPAndroidChart](https://github.com/PhilJay/MPAndroidChart) ⭐ 38,222 | 🐛 2,191 | 🌐 Java | 📅 2025-06-05 - An Android chart and graph library supporting scaling and dragging by gesture.
* [HelloCharts](https://github.com/lecho/hellocharts-android) ⭐ 7,845 | 🐛 293 | 🌐 Java | 📅 2021-06-01 - Chart and graph library with support for scaling, scrolling and animations.
...
* [Dagger 2](https://github.com/google/dagger) ⭐ 17,697 | 🐛 372 | 🌐 Java | 📅 2026-02-12 - A fast dependency injector for Android and Java.
...
* [Remoter](https://github.com/josesamuel/remoter) ⭐ 93 | 🐛 1 | 🌐 Kotlin | 📅 2025-12-18 - An alternative to Android AIDL for Android Remote IPC services using plain java interfaces.
...
* [Libgdx](https://libgdx.badlogicgames.com/) - Cross-platform game engine and SDK. [Open Source](https://github.com/libGDX/libGDX) ⭐ 24,801 | 🐛 328 | 🌐 Java | 📅 2026-02-03
...
* [ShimmerLayout](https://github.com/team-supercharge/ShimmerLayout) ⭐ 2,524 | 🐛 18 | 🌐 Java | 📅 2020-03-26 - Memory efficient shimmering effect for Android applications.
...
* [MaterialDrawer](https://github.com/mikepenz/MaterialDrawer) ⭐ 11,658 | 🐛 15 | 🌐 Kotlin | 📅 2026-02-09 - Simple take on a material design navigation drawer.
* [SlidingMenu](https://github.com/jfeinstein10/SlidingMenu) ⭐ 11,028 | 🐛 307 | 🌐 Java | 📅 2021-09-19 - Library to create applications with slide-in menus.
...
* [PagerSlidingTabStrip](https://github.com/astuetz/PagerSlidingTabStrip) ⭐ 152 | 🐛 228 | 🌐 Java | 📅 2018-10-06 - An interactive indicator to navigate between the different pages of a ViewPager.
...
* [Android View Animations](https://github.com/daimajia/AndroidViewAnimations) ⭐ 12,479 | 🐛 66 | 🌐 Java | 📅 2021-08-18 - Cute view animation collection.
...
* [Compressor](https://github.com/zetbaitsu/Compressor) ⭐ 7,224 | 🐛 142 | 🌐 Kotlin | 📅 2023-11-21 - Compressor is a lightweight and powerful android image compression library.
...
* [Glide](https://github.com/bumptech/glide) ⭐ 35,027 | 🐛 629 | 🌐 Java | 📅 2026-02-11 - An image loading and caching library for Android focused on smooth scrolling, Recommended by Google.
* [Picasso](https://github.com/square/picasso) ⭐ 19,104 | 🐛 213 | 🌐 Kotlin | 📅 2024-11-06 - A powerful image downloading and caching library for Android.
* [Fresco](https://github.com/facebook/fresco) ⭐ 17,154 | 🐛 260 | 🌐 Java | 📅 2026-02-12 - An Android library for managing images and the memory they use.
...
* [Coil](https://github.com/coil-kt/coil) ⭐ 11,701 | 🐛 56 | 🌐 Kotlin | 📅 2026-02-13 - Image loading for Android backed by Kotlin Coroutines.
...
* [ijkplayer](https://github.com/Bilibili/ijkplayer) ⭐ 33,117 | 🐛 2,895 | 🌐 C | 📅 2024-08-13 - Android/iOS video player based on FFmpeg n3.2, with MediaCodec, VideoToolbox support.
* [Exoplayer](https://github.com/google/ExoPlayer) ⭐ 21,933 | 🐛 633 | 🌐 Java | 📅 2025-12-23 - ExoPlayer is an application level media player for Android, allow  playing audio and video both locally and over the Internet.
...
* [Gson](https://github.com/google/gson) ⭐ 24,343 | 🐛 332 | 🌐 Java | 📅 2026-02-01 - Gson is a Java library used for serializing and deserializing Java objects from and into JSON.
* [Moshi](https://github.com/square/moshi) ⭐ 10,106 | 🐛 97 | 🌐 Kotlin | 📅 2026-02-05 - A modern JSON library for Android and Java.
* [Jackson JSON Processor](https://github.com/FasterXML/jackson) ⭐ 9,665 | 🐛 1 | 📅 2026-02-13 - High-performance JSON processor.
...
* [OkHttp](https://github.com/square/okhttp) ⭐ 46,880 | 🐛 85 | 🌐 Kotlin | 📅 2026-02-12 - An HTTP+SPDY client for Android and Java applications.
* [Ion](https://github.com/koush/ion) ⭐ 6,269 | 🐛 337 | 🌐 Java | 📅 2024-02-01 - Good networking library for android.
* [Fast-Android-Networking](https://github.com/amitshekhariitbhu/Fast-Android-Networking) ⭐ 5,884 | 🐛 233 | 🌐 Java | 📅 2026-02-05 - A Complete Fast Android Networking Library that also support HTTP/2.
...
* [logger](https://github.com/orhanobut/logger) ⭐ 13,890 | 🐛 81 | 🌐 Java | 📅 2022-09-14 - Simple, pretty and powerful logger for android
* [timber](https://github.com/JakeWharton/timber) ⭐ 10,789 | 🐛 61 | 🌐 Kotlin | 📅 2026-02-12 - A logger with a small, extensible API which provides utility on top of Android's normal Log class.
* [LoggingInterceptor](https://github.com/ihsanbal/LoggingInterceptor) ⭐ 1,348 | 🐛 3 | 🌐 Kotlin | 📅 2026-02-02 - An OkHttp interceptor which pretty logs request and response data.
...
* [SQLite Asset Helper](https://github.com/jgilfelt/android-sqlite-asset-helper) ⭐ 2,246 | 🐛 78 | 🌐 Java | 📅 2021-09-23 - manage database creation and version management using an application's raw asset files.
...
* [LeakCanary](https://github.com/square/leakcanary) ⭐ 29,890 | 🐛 153 | 🌐 Kotlin | 📅 2026-02-04 - Catch memory leaks as they occur.
...
* [Androl4b](https://github.com/sh4hin/Androl4b) ⭐ 1,154 | 🐛 5 | 📅 2023-05-31 - A vm for assessing android applications.
...
* [Stetho](https://github.com/facebook/stetho) ⭐ 12,716 | 🐛 84 | 🌐 Java | 📅 2024-10-26 - Debug hierarchy and network from chrome.
* [Android Debug Bridge - ADB](https://github.com/mzlogin/awesome-adb/blob/master/README.en.md) ⭐ 12,192 | 🐛 49 | 📅 2024-12-18 - a command-line tool to assist in debugging Android-powered devices
* [Android Debug Database](https://github.com/amitshekhariitbhu/Android-Debug-Database) ⭐ 8,631 | 🐛 82 | 🌐 Java | 📅 2026-02-05 - Android Debug Database is a powerful library for debugging databases and shared preferences in Android applications.
...
* [ADB Enhanced](https://github.com/ashishb/adb-enhanced) ⭐ 1,357 | 🐛 0 | 🌐 Python | 📅 2026-02-13 - a command-line wrapper around ADB for developers, so that, developers don't have to remember esoteric version-dependent commands
...
* [Permission Dispatcher](https://github.com/permissions-dispatcher/PermissionsDispatcher) ⭐ 11,213 | 🐛 32 | 🌐 Java | 📅 2023-11-10 - Simple annotation-based API to handle runtime permissions.
...
* [Guava: Google Core Libraries for Java](https://github.com/google/guava) ⭐ 51,469 | 🐛 720 | 🌐 Java | 📅 2026-02-13 - Collections, caching, primitives support, concurrency libraries, common annotations, string processing, I/O, and so forth.
* [RxJava](https://github.com/ReactiveX/RxJava) ⭐ 48,527 | 🐛 20 | 🌐 Java | 📅 2026-02-06- RxJava – Reactive Extensions for the JVM – a library for composing asynchronous and event-based programs using observable sequences for the Java VM.
* [ZXing Android-Integration](https://github.com/zxing/zxing) ⭐ 33,853 | 🐛 9 | 🌐 Java | 📅 2026-02-04 - Integration with Barcode Scanner via Intent.
* [RxAndroid](https://github.com/ReactiveX/RxAndroid) ⭐ 20,219 | 🐛 1 | 🌐 Java | 📅 2025-11-21 - Adds minimum RxJava bindings for easy writing of reactive Android java code.
...
* [AboutLibraries](https://github.com/mikepenz/AboutLibraries) ⭐ 4,220 | 🐛 8 | 🌐 Kotlin | 📅 2026-02-09 - Automatically generates an About this app section, with a list of used libraries.
...
* [Sensey](https://github.com/nisrulz/sensey) ⭐ 2,667 | 🐛 27 | 🌐 Java | 📅 2024-07-07 - Detecting gestures in a snap.
...
* [Licensee](https://github.com/cashapp/licensee) ⭐ 738 | 🐛 30 | 🌐 Kotlin | 📅 2026-02-12 - Licensee is a Gradle plugin which validates the licenses of your dependency graph match what you expect, or it fails your build!
...
* [Android Tips & Tricks](https://github.com/nisrulz/android-tips-tricks) ⭐ 4,755 | 🐛 2 | 🌐 Java | 📅 2025-06-08 - Cheatsheet about tips and tricks for Android Development.
...
* [Android Architecture Blueprints](https://github.com/android/architecture-samples) ⭐ 45,554 | 🐛 216 | 🌐 Kotlin | 📅 2026-02-11 - The Android Architecture Blueprints project demonstrates strategies to help solve or avoid common android problems.
...
* [React Native](https://github.com/facebook/react-native) ⭐ 125,352 | 🐛 1,196 | 🌐 C++ | 📅 2026-02-13 - A framework for building native apps with React by Facebook.
* [Capacitor](https://github.com/ionic-team/capacitor) ⭐ 14,994 | 🐛 298 | 🌐 TypeScript | 📅 2026-02-12 - Build cross-platform Native Progressive Web Apps for iOS, Android, and the web. Very promising Cordova alternative.
* [Apache Cordova](https://github.com/apache/cordova-android) ⭐ 3,774 | 🐛 88 | 🌐 JavaScript | 📅 2026-01-21 - Cordova based applications are, at the core, applications written with web technology: HTML, CSS and JavaScript.
...
* [Kotlin coding puzzles](https://github.com/igorwojda/kotlin-coding-puzzle) ⭐ 1,048 | 🐛 16 | 🌐 Kotlin | 📅 2026-02-05 - Set of programming challenges thats helps to improve whiteboard coding and problem-solving skills.
...
* [Booster](https://github.com/didi/booster) ⭐ 5,060 | 🐛 52 | 🌐 Kotlin | 📅 2026-02-04 - Booster is an optimization toolkit for Android applications.
...
Other amazingly awesome lists can be found in the [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,215 | 🐛 44 | 🌐 Ruby | 📅 2024-06-02 list.
