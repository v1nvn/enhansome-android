...
A curated list of awesome Android [libraries](#libraries) and [resources](#resources). For general Java libraries have a look at [awesome-java](https://github.com/akullpp/awesome-java) ⭐ 47,388 | 🐛 20 | 📅 2026-02-07.
...
* [Libgdx](https://libgdx.badlogicgames.com/) - Cross-platform game engine and SDK. [Open Source](https://github.com/libGDX/libGDX) ⭐ 24,940 | 🐛 331 | 🌐 Java | 📅 2026-02-27
...
* [DragListView](https://github.com/woxblom/DragListView) ⭐ 707 | 🐛 0 | 🌐 Java | 📅 2025-05-08 - Drag and drop to reorder items in a list, grid or board.
...
* [Glide](https://github.com/bumptech/glide) ⭐ 35,031 | 🐛 633 | 🌐 Java | 📅 2026-03-11 - An image loading and caching library for Android focused on smooth scrolling, Recommended by Google.
* [Picasso](https://github.com/square/picasso) ⭐ 19,062 | 🐛 214 | 🌐 Kotlin | 📅 2024-11-06 - A powerful image downloading and caching library for Android.
* [Fresco](https://github.com/facebook/fresco) ⭐ 17,164 | 🐛 259 | 🌐 Java | 📅 2026-03-23 - An Android library for managing images and the memory they use.
* [Universal Image Loader](https://github.com/nostra13/Android-Universal-Image-Loader) ⭐ 17,059 | 🐛 460 | 🌐 Java | 📅 2024-08-15 - Asynchronous, out of the box loading and caching of images.
* [Coil](https://github.com/coil-kt/coil) ⭐ 11,742 | 🐛 61 | 🌐 Kotlin | 📅 2026-03-23 - Image loading for Android backed by Kotlin Coroutines.
...
* [ijkplayer](https://github.com/Bilibili/ijkplayer) ⭐ 33,125 | 🐛 2,895 | 🌐 C | 📅 2024-08-13 - Android/iOS video player based on FFmpeg n3.2, with MediaCodec, VideoToolbox support.
...
* [Camera](https://github.com/duanhong169/Camera) ⭐ 139 | 🐛 16 | 🌐 Java | 📅 2018-09-18 - Use Android camera to take pictures and videos, based on camera2 api.
...
* [Moshi](https://github.com/square/moshi) ⭐ 10,119 | 🐛 99 | 🌐 Kotlin | 📅 2026-03-23 - A modern JSON library for Android and Java.
...
* [OkHttp](https://github.com/square/okhttp) ⭐ 46,921 | 🐛 89 | 🌐 Kotlin | 📅 2026-03-23 - An HTTP+SPDY client for Android and Java applications.
...
* [timber](https://github.com/JakeWharton/timber) ⭐ 10,809 | 🐛 62 | 🌐 Kotlin | 📅 2026-03-23 - A logger with a small, extensible API which provides utility on top of Android's normal Log class.
...
* [Nitrite Database](https://github.com/dizitart/nitrite-database) ⭐ 896 | 🐛 1 | 🌐 Java | 📅 2026-03-24 - A NoSQL embedded document store for Android with MongoDb like API.
...
* [LeakCanary](https://github.com/square/leakcanary) ⭐ 29,918 | 🐛 155 | 🌐 Kotlin | 📅 2026-03-06 - Catch memory leaks as they occur.
...
* [Stetho](https://github.com/facebook/stetho) ⭐ 12,702 | 🐛 85 | 🌐 Java | 📅 2024-10-26 - Debug hierarchy and network from chrome.
...
* [SmartGattLib](https://github.com/movisens/SmartGattLib) ⭐ 284 | 🐛 1 | 🌐 Java | 📅 2026-03-20 - Simplifies the work with Bluetooth SMART devices (a.k.a. Bluetooth Low Energy in Bluetooth 4.0).
...
* [RxJava](https://github.com/ReactiveX/RxJava) ⭐ 48,469 | 🐛 14 | 🌐 Java | 📅 2026-03-23- RxJava – Reactive Extensions for the JVM – a library for composing asynchronous and event-based programs using observable sequences for the Java VM.
...
* [RxAndroid](https://github.com/ReactiveX/RxAndroid) ⭐ 20,180 | 🐛 1 | 🌐 Java | 📅 2025-11-21 - Adds minimum RxJava bindings for easy writing of reactive Android java code.
...
* [AboutLibraries](https://github.com/mikepenz/AboutLibraries) ⭐ 4,246 | 🐛 11 | 🌐 Kotlin | 📅 2026-03-23 - Automatically generates an About this app section, with a list of used libraries.
...
* [Sensey](https://github.com/nisrulz/sensey) ⭐ 2,663 | 🐛 27 | 🌐 Java | 📅 2024-07-07 - Detecting gestures in a snap.
...
* [Licensee](https://github.com/cashapp/licensee) ⭐ 741 | 🐛 33 | 🌐 Kotlin | 📅 2026-03-23 - Licensee is a Gradle plugin which validates the licenses of your dependency graph match what you expect, or it fails your build!
...
* [Android Architecture Blueprints](https://github.com/android/architecture-samples) ⭐ 45,617 | 🐛 217 | 🌐 Kotlin | 📅 2026-03-23 - The Android Architecture Blueprints project demonstrates strategies to help solve or avoid common android problems.
...
* [React Native](https://github.com/facebook/react-native) ⭐ 125,631 | 🐛 1,254 | 🌐 C++ | 📅 2026-03-24 - A framework for building native apps with React by Facebook.
* [Capacitor](https://github.com/ionic-team/capacitor) ⭐ 15,321 | 🐛 110 | 🌐 TypeScript | 📅 2026-03-23 - Build cross-platform Native Progressive Web Apps for iOS, Android, and the web. Very promising Cordova alternative.
...
Other amazingly awesome lists can be found in the [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,305 | 🐛 49 | 🌐 Ruby | 📅 2024-06-02 list.
