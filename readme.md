...
[<img src="https://raw.githubusercontent.com/jstumpp/awesome-android/master/awesome-android.png">](https://github.com/jstumpp/awesome-android) ⭐ 12,072 | 🐛 69 | 📅 2025-10-27
...
A curated list of awesome Android [libraries](#libraries) and [resources](#resources). For general Java libraries have a look at [awesome-java](https://github.com/akullpp/awesome-java) ⭐ 47,714 | 🐛 4 | 📅 2026-04-12.
...
* [HelloCharts](https://github.com/lecho/hellocharts-android) ⭐ 7,626 | 🐛 293 | 🌐 Java | 📅 2021-06-01 - Chart and graph library with support for scaling, scrolling and animations.
...
* [Dagger 2](https://github.com/google/dagger) ⭐ 17,700 | 🐛 358 | 🌐 Java | 📅 2026-04-22 - A fast dependency injector for Android and Java.
...
* [Libgdx](https://libgdx.badlogicgames.com/) - Cross-platform game engine and SDK. [Open Source](https://github.com/libGDX/libGDX) ⭐ 25,026 | 🐛 329 | 🌐 Java | 📅 2026-04-19
...
* [ShapeImageView](https://github.com/siyamed/android-shape-imageview) ⭐ 2,655 | 🐛 63 | 🌐 Java | 📅 2019-07-27 - Library to display images in different shapes.
...
* [Glide](https://github.com/bumptech/glide) ⭐ 35,024 | 🐛 635 | 🌐 Java | 📅 2026-04-22 - An image loading and caching library for Android focused on smooth scrolling, Recommended by Google.
* [Picasso](https://github.com/square/picasso) ⭐ 18,878 | 🐛 214 | 🌐 Kotlin | 📅 2024-11-06 - A powerful image downloading and caching library for Android.
* [Fresco](https://github.com/facebook/fresco) ⭐ 17,148 | 🐛 259 | 🌐 Java | 📅 2026-04-22 - An Android library for managing images and the memory they use.
* [Universal Image Loader](https://github.com/nostra13/Android-Universal-Image-Loader) ⭐ 16,890 | 🐛 459 | 🌐 Java | 📅 2024-08-15 - Asynchronous, out of the box loading and caching of images.
* [Coil](https://github.com/coil-kt/coil) ⭐ 11,768 | 🐛 67 | 🌐 Kotlin | 📅 2026-04-22 - Image loading for Android backed by Kotlin Coroutines.
...
* [Gson](https://github.com/google/gson) ⭐ 24,209 | 🐛 341 | 🌐 Java | 📅 2026-04-17 - Gson is a Java library used for serializing and deserializing Java objects from and into JSON.
* [Moshi](https://github.com/square/moshi) ⭐ 10,128 | 🐛 98 | 🌐 Kotlin | 📅 2026-04-23 - A modern JSON library for Android and Java.
* [Jackson JSON Processor](https://github.com/FasterXML/jackson) ⭐ 9,705 | 🐛 0 | 📅 2026-04-19 - High-performance JSON processor.
...
* [OkHttp](https://github.com/square/okhttp) ⭐ 46,933 | 🐛 101 | 🌐 Kotlin | 📅 2026-04-22 - An HTTP+SPDY client for Android and Java applications.
...
* [SQLite Asset Helper](https://github.com/jgilfelt/android-sqlite-asset-helper) ⭐ 2,180 | 🐛 78 | 🌐 Java | 📅 2021-09-23 - manage database creation and version management using an application's raw asset files.
...
* [Weak handler](https://github.com/badoo/android-weak-handler) ⭐ 1,538 | 🐛 5 | 🌐 Java | 📅 2022-02-24 - Memory safer implementation of android.os.Handler.
...
* [SmartGattLib](https://github.com/movisens/SmartGattLib) ⭐ 284 | 🐛 1 | 🌐 Java | 📅 2026-04-22 - Simplifies the work with Bluetooth SMART devices (a.k.a. Bluetooth Low Energy in Bluetooth 4.0).
...
* [True Time](https://github.com/instacart/truetime-android) ⭐ 1,469 | 🐛 41 | 🌐 Kotlin | 📅 2023-06-12 - Android NTP time library. Get the true current time impervious to device clock time changes.

### Runtime Permissions

* [Permission Dispatcher](https://github.com/permissions-dispatcher/PermissionsDispatcher) ⭐ 11,187 | 🐛 31 | 🌐 Java | 📅 2023-11-10 - Simple annotation-based API to handle runtime permissions.
...
* [Guava: Google Core Libraries for Java](https://github.com/google/guava) ⭐ 51,494 | 🐛 728 | 🌐 Java | 📅 2026-04-22 - Collections, caching, primitives support, concurrency libraries, common annotations, string processing, I/O, and so forth.
* [RxJava](https://github.com/ReactiveX/RxJava) ⭐ 48,292 | 🐛 21 | 🌐 Java | 📅 2026-04-22- RxJava – Reactive Extensions for the JVM – a library for composing asynchronous and event-based programs using observable sequences for the Java VM.
...
* [RxAndroid](https://github.com/ReactiveX/RxAndroid) ⭐ 20,006 | 🐛 1 | 🌐 Java | 📅 2026-03-24 - Adds minimum RxJava bindings for easy writing of reactive Android java code.
...
* [Gradle buildSrcVersions](https://github.com/jmfayard/buildSrcVersions) ⭐ 1,705 | 🐛 130 | 🌐 Kotlin | 📅 2025-08-16 - A kotlin dsl to simplify dependencies management
* [Licensee](https://github.com/cashapp/licensee) ⭐ 746 | 🐛 33 | 🌐 Kotlin | 📅 2026-04-22 - Licensee is a Gradle plugin which validates the licenses of your dependency graph match what you expect, or it fails your build!
...
* [Android Architecture Blueprints](https://github.com/android/architecture-samples) ⭐ 45,654 | 🐛 219 | 🌐 Kotlin | 📅 2026-04-23 - The Android Architecture Blueprints project demonstrates strategies to help solve or avoid common android problems.
...
* [React Native](https://github.com/facebook/react-native) ⭐ 125,705 | 🐛 1,284 | 🌐 C++ | 📅 2026-04-23 - A framework for building native apps with React by Facebook.
* [Capacitor](https://github.com/ionic-team/capacitor) ⭐ 15,503 | 🐛 112 | 🌐 TypeScript | 📅 2026-04-22 - Build cross-platform Native Progressive Web Apps for iOS, Android, and the web. Very promising Cordova alternative.
* [Apache Cordova](https://github.com/apache/cordova-android) ⭐ 3,779 | 🐛 90 | 🌐 JavaScript | 📅 2026-04-23 - Cordova based applications are, at the core, applications written with web technology: HTML, CSS and JavaScript.
...
Other amazingly awesome lists can be found in the [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,378 | 🐛 52 | 🌐 Ruby | 📅 2024-06-02 list.
