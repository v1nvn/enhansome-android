...
[<img src="https://raw.githubusercontent.com/jstumpp/awesome-android/master/awesome-android.png">](https://github.com/jstumpp/awesome-android) ⭐ 12,061 | 🐛 70 | 📅 2025-10-27
...
A curated list of awesome Android [libraries](#libraries) and [resources](#resources). For general Java libraries have a look at [awesome-java](https://github.com/akullpp/awesome-java) ⭐ 47,633 | 🐛 2 | 📅 2026-04-12.
...
* [MPAndroidChart](https://github.com/PhilJay/MPAndroidChart) ⭐ 38,223 | 🐛 2,190 | 🌐 Java | 📅 2025-06-05 - An Android chart and graph library supporting scaling and dragging by gesture.
* [HelloCharts](https://github.com/lecho/hellocharts-android) ⭐ 7,668 | 🐛 293 | 🌐 Java | 📅 2021-06-01 - Chart and graph library with support for scaling, scrolling and animations.
* [WilliamChart](https://github.com/diogobernardino/WilliamChart) ⭐ 5,110 | 🐛 34 | 🌐 Kotlin | 📅 2025-10-04 - Chart library with good motion capabilities.
...
* [EazeGraph](https://github.com/blackfizz/EazeGraph) ⭐ 1,596 | 🐛 52 | 🌐 Java | 📅 2016-11-11 - Chart and graph library.
...
* [Dagger 2](https://github.com/google/dagger) ⭐ 17,705 | 🐛 359 | 🌐 Java | 📅 2026-04-09 - A fast dependency injector for Android and Java.
...
* [Libgdx](https://libgdx.badlogicgames.com/) - Cross-platform game engine and SDK. [Open Source](https://github.com/libGDX/libGDX) ⭐ 25,003 | 🐛 332 | 🌐 Java | 📅 2026-04-13
...
* [Themis](https://github.com/cossacklabs/themis) ⭐ 1,958 | 🐛 32 | 🌐 C | 📅 2026-01-09 - Multi-language framework for making typical encryption schemes easy to use: data at rest, authenticated data exchange, transport protection, authentication, and so on.
...
* [Litho (By Facebook)](https://github.com/facebook/litho) ⭐ 7,774 | 🐛 116 | 🌐 Kotlin | 📅 2026-04-13 - A declarative framework for building efficient UIs on Android.
...
* [Cardslib](https://github.com/gabrielemariotti/cardslib) ⭐ 4,631 | 🐛 183 | 🌐 Java | 📅 2021-11-18 - Android Library to build a UI Card.
...
* [MaterialProgressBar](https://github.com/zhanghai/MaterialProgressBar) ⭐ 2,234 | 🐛 7 | 🌐 Java | 📅 2020-07-03 - Material design ProgressBar with consistent appearance.
...
* [FadingActionBar](https://github.com/ManuelPeinado/FadingActionBar) ⭐ 2,848 | 🐛 85 | 🌐 Java | 📅 2018-05-05 - Fading action bar effect that can be seen in the new Play Music app.
...
* [SlidingMenu](https://github.com/jfeinstein10/SlidingMenu) ⭐ 11,021 | 🐛 306 | 🌐 Java | 📅 2021-09-19 - Library to create applications with slide-in menus.
...
* [RecyclerTabLayout](https://github.com/nshmura/RecyclerTabLayout) ⭐ 1,355 | 🐛 13 | 🌐 Java | 📅 2019-08-29 - An efficient TabLayout library implemented with RecyclerView.
...
* [Spotlight](https://github.com/TakuSemba/Spotlight) ⭐ 3,665 | 🐛 31 | 🌐 Kotlin | 📅 2022-12-03 - Android Library that lights items for tutorials or walk-throughs etc...
* [Android-Transition](https://github.com/kaichunlin/android-transition) ⭐ 612 | 🐛 3 | 🌐 Java | 📅 2018-05-04 - Allows the easy creation of view transitions that react to user inputs.
...
* [Glide](https://github.com/bumptech/glide) ⭐ 35,025 | 🐛 634 | 🌐 Java | 📅 2026-04-07 - An image loading and caching library for Android focused on smooth scrolling, Recommended by Google.
* [Picasso](https://github.com/square/picasso) ⭐ 18,918 | 🐛 214 | 🌐 Kotlin | 📅 2024-11-06 - A powerful image downloading and caching library for Android.
* [Fresco](https://github.com/facebook/fresco) ⭐ 17,153 | 🐛 258 | 🌐 Java | 📅 2026-04-14 - An Android library for managing images and the memory they use.
...
* [Coil](https://github.com/coil-kt/coil) ⭐ 11,759 | 🐛 62 | 🌐 Kotlin | 📅 2026-04-14 - Image loading for Android backed by Kotlin Coroutines.
...
* [Exoplayer](https://github.com/google/ExoPlayer) ⭐ 21,920 | 🐛 632 | 🌐 Java | 📅 2025-12-23 - ExoPlayer is an application level media player for Android, allow  playing audio and video both locally and over the Internet.
...
* [Gson](https://github.com/google/gson) ⭐ 24,245 | 🐛 340 | 🌐 Java | 📅 2026-04-10 - Gson is a Java library used for serializing and deserializing Java objects from and into JSON.
* [Moshi](https://github.com/square/moshi) ⭐ 10,126 | 🐛 98 | 🌐 Kotlin | 📅 2026-04-12 - A modern JSON library for Android and Java.
* [Jackson JSON Processor](https://github.com/FasterXML/jackson) ⭐ 9,702 | 🐛 0 | 📅 2026-03-11 - High-performance JSON processor.
...
* [OkHttp](https://github.com/square/okhttp) ⭐ 46,923 | 🐛 97 | 🌐 Kotlin | 📅 2026-04-14 - An HTTP+SPDY client for Android and Java applications.
* [Ion](https://github.com/koush/ion) ⭐ 6,256 | 🐛 337 | 🌐 Java | 📅 2024-02-01 - Good networking library for android.
* [Fast-Android-Networking](https://github.com/amitshekhariitbhu/Fast-Android-Networking) ⭐ 5,894 | 🐛 232 | 🌐 Java | 📅 2026-02-05 - A Complete Fast Android Networking Library that also support HTTP/2.
...
* [logger](https://github.com/orhanobut/logger) ⭐ 13,874 | 🐛 81 | 🌐 Java | 📅 2022-09-14 - Simple, pretty and powerful logger for android
* [timber](https://github.com/JakeWharton/timber) ⭐ 10,811 | 🐛 62 | 🌐 Kotlin | 📅 2026-04-13 - A logger with a small, extensible API which provides utility on top of Android's normal Log class.
...
* [SQLite Asset Helper](https://github.com/jgilfelt/android-sqlite-asset-helper) ⭐ 2,198 | 🐛 78 | 🌐 Java | 📅 2021-09-23 - manage database creation and version management using an application's raw asset files.
* [DbInspector](https://github.com/infinum/android_dbinspector) ⭐ 955 | 🐛 1 | 🌐 Kotlin | 📅 2026-02-18 - Provides a simple way to view the contents of the in-app database for debugging purposes.
...
* [DBFlow](https://github.com/agrosner/DBFlow) ⭐ 4,859 | 🐛 45 | 🌐 Kotlin | 📅 2022-03-15 - Fast and powerful ORM with compile-time annotation processing.
* [requery](https://github.com/requery/requery) ⭐ 3,122 | 🐛 171 | 🌐 Java | 📅 2026-02-09 - Compile time ORM and SQL query library for Java & Android.
...
* [LeakCanary](https://github.com/square/leakcanary) ⭐ 29,918 | 🐛 159 | 🌐 Kotlin | 📅 2026-03-24 - Catch memory leaks as they occur.
...
* [Android Debug Bridge - ADB](https://github.com/mzlogin/awesome-adb/blob/master/README.en.md) ⭐ 12,277 | 🐛 50 | 📅 2024-12-18 - a command-line tool to assist in debugging Android-powered devices
* [Android Debug Database](https://github.com/amitshekhariitbhu/Android-Debug-Database) ⭐ 8,649 | 🐛 82 | 🌐 Java | 📅 2026-02-05 - Android Debug Database is a powerful library for debugging databases and shared preferences in Android applications.
...
* [ADB Enhanced](https://github.com/ashishb/adb-enhanced) ⭐ 1,366 | 🐛 0 | 🌐 Python | 📅 2026-04-10 - a command-line wrapper around ADB for developers, so that, developers don't have to remember esoteric version-dependent commands
* [Linx](https://github.com/pedrovgs/Lynx) ⭐ 790 | 🐛 9 | 🌐 Java | 📅 2026-01-16 - Show logcat inside the device for debug builds
...
* [Kommunicate Live Chat SDK](https://github.com/Kommunicate-io/Kommunicate-Android-Chat-SDK) ⭐ 79 | 🐛 1 | 🌐 Java | 📅 2026-04-14 - Kommunicate provides open source live chat sdk in android. Kommunicate lets you add real time live chat and in-app messaging in your mobile (android, iOS) applications and website for customer support.
...
* [Joda-Time Android](https://github.com/dlew/joda-time-android) ⭐ 2,625 | 🐛 3 | 🌐 Java | 📅 2026-03-09 - Joda-Time library with Android specialization.
...
* [Permission Dispatcher](https://github.com/permissions-dispatcher/PermissionsDispatcher) ⭐ 11,191 | 🐛 31 | 🌐 Java | 📅 2023-11-10 - Simple annotation-based API to handle runtime permissions.
...
* [Guava: Google Core Libraries for Java](https://github.com/google/guava) ⭐ 51,507 | 🐛 729 | 🌐 Java | 📅 2026-04-14 - Collections, caching, primitives support, concurrency libraries, common annotations, string processing, I/O, and so forth.
* [RxJava](https://github.com/ReactiveX/RxJava) ⭐ 48,336 | 🐛 22 | 🌐 Java | 📅 2026-04-14- RxJava – Reactive Extensions for the JVM – a library for composing asynchronous and event-based programs using observable sequences for the Java VM.
* [ZXing Android-Integration](https://github.com/zxing/zxing) ⭐ 33,913 | 🐛 3 | 🌐 Java | 📅 2026-04-08 - Integration with Barcode Scanner via Intent.
* [RxAndroid](https://github.com/ReactiveX/RxAndroid) ⭐ 20,049 | 🐛 1 | 🌐 Java | 📅 2026-03-24 - Adds minimum RxJava bindings for easy writing of reactive Android java code.
...
* [Licensee](https://github.com/cashapp/licensee) ⭐ 743 | 🐛 33 | 🌐 Kotlin | 📅 2026-04-13 - Licensee is a Gradle plugin which validates the licenses of your dependency graph match what you expect, or it fails your build!
...
* [Android Architecture Blueprints](https://github.com/android/architecture-samples) ⭐ 45,635 | 🐛 219 | 🌐 Kotlin | 📅 2026-04-14 - The Android Architecture Blueprints project demonstrates strategies to help solve or avoid common android problems.
...
* [React Native](https://github.com/facebook/react-native) ⭐ 125,675 | 🐛 1,297 | 🌐 C++ | 📅 2026-04-15 - A framework for building native apps with React by Facebook.
* [Capacitor](https://github.com/ionic-team/capacitor) ⭐ 15,452 | 🐛 109 | 🌐 TypeScript | 📅 2026-04-14 - Build cross-platform Native Progressive Web Apps for iOS, Android, and the web. Very promising Cordova alternative.
...
Other amazingly awesome lists can be found in the [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,363 | 🐛 50 | 🌐 Ruby | 📅 2024-06-02 list.
