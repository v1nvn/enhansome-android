...
[<img src="https://raw.githubusercontent.com/jstumpp/awesome-android/master/awesome-android.png">](https://github.com/jstumpp/awesome-android) ⭐ 12,084 | 🐛 75 | 📅 2025-10-27
...
A curated list of awesome Android [libraries](#libraries) and [resources](#resources). For general Java libraries have a look at [awesome-java](https://github.com/akullpp/awesome-java) ⭐ 47,796 | 🐛 4 | 📅 2026-04-12.
...
* [MPAndroidChart](https://github.com/PhilJay/MPAndroidChart) ⭐ 38,216 | 🐛 2,190 | 🌐 Java | 📅 2025-06-05 - An Android chart and graph library supporting scaling and dragging by gesture.
* [HelloCharts](https://github.com/lecho/hellocharts-android) ⭐ 7,625 | 🐛 293 | 🌐 Java | 📅 2021-06-01 - Chart and graph library with support for scaling, scrolling and animations.
* [WilliamChart](https://github.com/diogobernardino/WilliamChart) ⭐ 5,107 | 🐛 34 | 🌐 Kotlin | 📅 2025-10-04 - Chart library with good motion capabilities.
...
* [EazeGraph](https://github.com/blackfizz/EazeGraph) ⭐ 1,593 | 🐛 52 | 🌐 Java | 📅 2016-11-11 - Chart and graph library.
...
* [Dagger 2](https://github.com/google/dagger) ⭐ 17,701 | 🐛 357 | 🌐 Java | 📅 2026-04-30 - A fast dependency injector for Android and Java.
...
* [Libgdx](https://libgdx.badlogicgames.com/) - Cross-platform game engine and SDK. [Open Source](https://github.com/libGDX/libGDX) ⭐ 25,051 | 🐛 330 | 🌐 Java | 📅 2026-04-30
* [Rajawali](https://github.com/Rajawali/Rajawali) ⭐ 2,414 | 🐛 190 | 🌐 Java | 📅 2023-04-13 - Android OpenGL ES 2.0/3.0 Engine
* [JustWeEngine](https://github.com/lfkdsk/JustWeEngine) ⭐ 771 | 🐛 6 | 🌐 Java | 📅 2026-04-28 - An easy open source Android Native Game FrameWork.
...
* [Themis](https://github.com/cossacklabs/themis) ⭐ 1,963 | 🐛 31 | 🌐 C | 📅 2026-04-24 - Multi-language framework for making typical encryption schemes easy to use: data at rest, authenticated data exchange, transport protection, authentication, and so on.
...
* [Litho (By Facebook)](https://github.com/facebook/litho) ⭐ 7,767 | 🐛 115 | 🌐 Kotlin | 📅 2026-04-27 - A declarative framework for building efficient UIs on Android.
* [TapTargetView](https://github.com/KeepSafe/TapTargetView) ⭐ 5,462 | 🐛 56 | 🌐 Java | 📅 2024-10-08 - An implementation of tap targets from the Material Design guidelines for feature discovery.
...
* [Cardslib](https://github.com/gabrielemariotti/cardslib) ⭐ 4,625 | 🐛 183 | 🌐 Java | 📅 2021-11-18 - Android Library to build a UI Card.
...
* [ShimmerLayout](https://github.com/team-supercharge/ShimmerLayout) ⭐ 2,521 | 🐛 18 | 🌐 Java | 📅 2020-03-26 - Memory efficient shimmering effect for Android applications.
...
* [MaterialProgressBar](https://github.com/zhanghai/MaterialProgressBar) ⭐ 2,229 | 🐛 7 | 🌐 Java | 📅 2020-07-03 - Material design ProgressBar with consistent appearance.
* [TastyToast](https://github.com/yadav-rahul/TastyToast) ⭐ 2,019 | 🐛 19 | 🌐 Java | 📅 2019-08-20 - Toasts with icons and color.
* [AndroidFillableLoaders](https://github.com/JorgeCastilloPrz/AndroidFillableLoaders) ⭐ 1,977 | 🐛 15 | 🌐 Java | 📅 2022-07-20 - Fillable progress view working with SVG paths. Nice option too for creating interesting app logos.
...
* [Bubbles for Android](https://github.com/txusballesteros/bubbles-for-android) ⭐ 1,475 | 🐛 28 | 🌐 Java | 📅 2021-01-18 - Facebook like chat bubble library
* [SortableTableView](https://github.com/ISchwarz23/SortableTableView) ⭐ 1,048 | 🐛 51 | 🌐 Java | 📅 2021-04-17 - An Android library containing a simple TableView and an advanced SortableTableView providing a lot of customisation possibilities to fit all needs.
...
* [FadingActionBar](https://github.com/ManuelPeinado/FadingActionBar) ⭐ 2,845 | 🐛 85 | 🌐 Java | 📅 2018-05-05 - Fading action bar effect that can be seen in the new Play Music app.

#### Navigation

* [MaterialDrawer](https://github.com/mikepenz/MaterialDrawer) ⭐ 11,649 | 🐛 11 | 🌐 Kotlin | 📅 2026-04-14 - Simple take on a material design navigation drawer.
* [SlidingMenu](https://github.com/jfeinstein10/SlidingMenu) ⭐ 11,017 | 🐛 306 | 🌐 Java | 📅 2021-09-19 - Library to create applications with slide-in menus.
...
* [SlidingTutorial](https://github.com/Cleveroad/slidingtutorial-android) ⭐ 2,457 | 🐛 3 | 🌐 Java | 📅 2018-11-19 - Simple library that helps to create awesome sliding android app tutorials.
* [RecyclerTabLayout](https://github.com/nshmura/RecyclerTabLayout) ⭐ 1,352 | 🐛 13 | 🌐 Java | 📅 2019-08-29 - An efficient TabLayout library implemented with RecyclerView.
* [Floating-Navigation-View](https://github.com/andremion/Floating-Navigation-View) ⭐ 1,284 | 🐛 3 | 🌐 Java | 📅 2022-08-30 - A simple Floating Action Button that shows an anchored Navigation View.
* [PagerSlidingTabStrip](https://github.com/astuetz/PagerSlidingTabStrip) ⭐ 146 | 🐛 228 | 🌐 Java | 📅 2018-10-06 - An interactive indicator to navigate between the different pages of a ViewPager.
...
* [Android View Animations](https://github.com/daimajia/AndroidViewAnimations) ⭐ 12,462 | 🐛 66 | 🌐 Java | 📅 2021-08-18 - Cute view animation collection.
...
* [Compressor](https://github.com/zetbaitsu/Compressor) ⭐ 7,221 | 🐛 140 | 🌐 Kotlin | 📅 2026-03-05 - Compressor is a lightweight and powerful android image compression library.
* [android-crop](https://github.com/jdamcd/android-crop) ⚠️ Archived - Library project for cropping images.
* [ShapeImageView](https://github.com/siyamed/android-shape-imageview) ⭐ 2,654 | 🐛 63 | 🌐 Java | 📅 2019-07-27 - Library to display images in different shapes.
...
* [CircularImageView](https://github.com/Pkmmte/CircularImageView) ⭐ 1,170 | 🐛 47 | 🌐 Java | 📅 2017-08-16 - Custom view for circular images while maintaining the best draw performance.
...
* [Glide](https://github.com/bumptech/glide) ⭐ 35,026 | 🐛 635 | 🌐 Java | 📅 2026-04-29 - An image loading and caching library for Android focused on smooth scrolling, Recommended by Google.
* [Picasso](https://github.com/square/picasso) ⭐ 18,873 | 🐛 214 | 🌐 Kotlin | 📅 2024-11-06 - A powerful image downloading and caching library for Android.
* [Fresco](https://github.com/facebook/fresco) ⭐ 17,148 | 🐛 258 | 🌐 Java | 📅 2026-04-30 - An Android library for managing images and the memory they use.
* [Universal Image Loader](https://github.com/nostra13/Android-Universal-Image-Loader) ⭐ 16,886 | 🐛 459 | 🌐 Java | 📅 2024-08-15 - Asynchronous, out of the box loading and caching of images.
* [Coil](https://github.com/coil-kt/coil) ⭐ 11,775 | 🐛 61 | 🌐 Kotlin | 📅 2026-04-29 - Image loading for Android backed by Kotlin Coroutines.
...
* [ijkplayer](https://github.com/Bilibili/ijkplayer) ⭐ 33,147 | 🐛 2,895 | 🌐 C | 📅 2024-08-13 - Android/iOS video player based on FFmpeg n3.2, with MediaCodec, VideoToolbox support.
* [Exoplayer](https://github.com/google/ExoPlayer) ⭐ 21,914 | 🐛 631 | 🌐 Java | 📅 2025-12-23 - ExoPlayer is an application level media player for Android, allow  playing audio and video both locally and over the Internet.
...
* [MagicalCamera](https://github.com/fabian7593/MagicalCamera) ⭐ 341 | 🐛 8 | 🌐 Java | 📅 2019-02-27 - Simple way to take or select photos of your gallery, with other features for manage pictures.
...
* [Gson](https://github.com/google/gson) ⭐ 24,215 | 🐛 339 | 🌐 Java | 📅 2026-05-01 - Gson is a Java library used for serializing and deserializing Java objects from and into JSON.
* [Moshi](https://github.com/square/moshi) ⭐ 10,128 | 🐛 98 | 🌐 Kotlin | 📅 2026-04-28 - A modern JSON library for Android and Java.
* [Jackson JSON Processor](https://github.com/FasterXML/jackson) ⭐ 9,708 | 🐛 2 | 📅 2026-04-30 - High-performance JSON processor.
...
* [OkHttp](https://github.com/square/okhttp) ⭐ 46,947 | 🐛 106 | 🌐 Kotlin | 📅 2026-04-27 - An HTTP+SPDY client for Android and Java applications.
* [Ion](https://github.com/koush/ion) ⭐ 6,255 | 🐛 337 | 🌐 Java | 📅 2024-02-01 - Good networking library for android.
* [Fast-Android-Networking](https://github.com/amitshekhariitbhu/Fast-Android-Networking) ⭐ 5,900 | 🐛 232 | 🌐 Java | 📅 2026-02-05 - A Complete Fast Android Networking Library that also support HTTP/2.
...
* [IceNet](https://github.com/anton46/IceNet) ⭐ 64 | 🐛 1 | 🌐 Java | 📅 2014-11-18 - Fast, Simple and Easy Networking for Android
...
* [logger](https://github.com/orhanobut/logger) ⭐ 13,863 | 🐛 81 | 🌐 Java | 📅 2022-09-14 - Simple, pretty and powerful logger for android
* [timber](https://github.com/JakeWharton/timber) ⭐ 10,814 | 🐛 62 | 🌐 Kotlin | 📅 2026-04-28 - A logger with a small, extensible API which provides utility on top of Android's normal Log class.
...
* [Logback Android](https://github.com/tony19/logback-android) ⭐ 1,260 | 🐛 38 | 🌐 Java | 📅 2026-04-02 - Logback port to Android which provides a highly configurable logging framework for Android apps.
...
* [Realm](https://github.com/realm/realm-java) ⭐ 11,478 | 🐛 395 | 🌐 Java | 📅 2025-09-15 - The alternative to SQLite and ORMs: Simple, modern and fast! Object oriented API and multi platform support.
* [SQLite Asset Helper](https://github.com/jgilfelt/android-sqlite-asset-helper) ⭐ 2,179 | 🐛 78 | 🌐 Java | 📅 2021-09-23 - manage database creation and version management using an application's raw asset files.
* [DbInspector](https://github.com/infinum/android_dbinspector) ⭐ 952 | 🐛 1 | 🌐 Kotlin | 📅 2026-04-20 - Provides a simple way to view the contents of the in-app database for debugging purposes.
* [Nitrite Database](https://github.com/dizitart/nitrite-database) ⭐ 901 | 🐛 7 | 🌐 Java | 📅 2026-04-27 - A NoSQL embedded document store for Android with MongoDb like API.
...
* [DBFlow](https://github.com/agrosner/DBFlow) ⭐ 4,855 | 🐛 45 | 🌐 Kotlin | 📅 2022-03-15 - Fast and powerful ORM with compile-time annotation processing.
...
* [LeakCanary](https://github.com/square/leakcanary) ⭐ 29,922 | 🐛 161 | 🌐 Kotlin | 📅 2026-03-24 - Catch memory leaks as they occur.
...
* [Weak handler](https://github.com/badoo/android-weak-handler) ⭐ 1,537 | 🐛 5 | 🌐 Java | 📅 2022-02-24 - Memory safer implementation of android.os.Handler.
* [Androl4b](https://github.com/sh4hin/Androl4b) ⭐ 1,160 | 🐛 5 | 📅 2023-05-31 - A vm for assessing android applications.
...
* [Android Debug Bridge - ADB](https://github.com/mzlogin/awesome-adb/blob/master/README.en.md) ⭐ 12,293 | 🐛 50 | 📅 2024-12-18 - a command-line tool to assist in debugging Android-powered devices
* [Android Debug Database](https://github.com/amitshekhariitbhu/Android-Debug-Database) ⭐ 8,653 | 🐛 83 | 🌐 Java | 📅 2026-02-05 - Android Debug Database is a powerful library for debugging databases and shared preferences in Android applications.
* [Pidcat](https://github.com/JakeWharton/pidcat) ⭐ 4,939 | 🐛 67 | 🌐 Python | 📅 2024-05-10 - a colored command-line ADB wrapper that only shows log entries for a specific application package
* [Scalpel](https://github.com/JakeWharton/scalpel) ⚠️ Archived - View the entire hierarchy in 3d in the phone.
* [ADB Enhanced](https://github.com/ashishb/adb-enhanced) ⭐ 1,370 | 🐛 0 | 🌐 Python | 📅 2026-04-30 - a command-line wrapper around ADB for developers, so that, developers don't have to remember esoteric version-dependent commands
...
* [SmartGattLib](https://github.com/movisens/SmartGattLib) ⭐ 284 | 🐛 1 | 🌐 Java | 📅 2026-04-23 - Simplifies the work with Bluetooth SMART devices (a.k.a. Bluetooth Low Energy in Bluetooth 4.0).

### Chat & Messaging

* [Qiscus SDK](https://github.com/qiscus/qiscus-sdk-android) ⭐ 203 | 🐛 0 | 🌐 Java | 📅 2026-04-21 - Qiscus SDK is a lightweight and powerful android chat library. Qiscus SDK will allow you to easily integrating Qiscus engine with your apps to make cool chatting application.
* [Kommunicate Live Chat SDK](https://github.com/Kommunicate-io/Kommunicate-Android-Chat-SDK) ⭐ 80 | 🐛 0 | 🌐 Java | 📅 2026-04-16 - Kommunicate provides open source live chat sdk in android. Kommunicate lets you add real time live chat and in-app messaging in your mobile (android, iOS) applications and website for customer support.
...
* [AppUpdater](https://github.com/javiersantos/AppUpdater) ⭐ 2,023 | 🐛 60 | 🌐 Java | 📅 2024-06-28 - comprehensive and feature rich library, including support for checks at Amazon and FDroid.
...
* [Joda-Time Android](https://github.com/dlew/joda-time-android) ⭐ 2,620 | 🐛 2 | 🌐 Java | 📅 2026-04-29 - Joda-Time library with Android specialization.
...
* [Permission Dispatcher](https://github.com/permissions-dispatcher/PermissionsDispatcher) ⭐ 11,184 | 🐛 31 | 🌐 Java | 📅 2023-11-10 - Simple annotation-based API to handle runtime permissions.
...
* [Guava: Google Core Libraries for Java](https://github.com/google/guava) ⭐ 51,499 | 🐛 733 | 🌐 Java | 📅 2026-04-30 - Collections, caching, primitives support, concurrency libraries, common annotations, string processing, I/O, and so forth.
* [RxJava](https://github.com/ReactiveX/RxJava) ⭐ 48,287 | 🐛 20 | 🌐 Java | 📅 2026-04-29- RxJava – Reactive Extensions for the JVM – a library for composing asynchronous and event-based programs using observable sequences for the Java VM.
* [ZXing Android-Integration](https://github.com/zxing/zxing) ⭐ 33,919 | 🐛 3 | 🌐 Java | 📅 2026-04-30 - Integration with Barcode Scanner via Intent.
* [RxAndroid](https://github.com/ReactiveX/RxAndroid) ⭐ 20,002 | 🐛 1 | 🌐 Java | 📅 2026-03-24 - Adds minimum RxJava bindings for easy writing of reactive Android java code.
...
* [Gradle Retrolambda Plugin](https://github.com/evant/gradle-retrolambda) ⭐ 5,265 | 🐛 76 | 🌐 Java | 📅 2023-07-24 - Java 8 Lambdas on Android!
* [AboutLibraries](https://github.com/mikepenz/AboutLibraries) ⭐ 4,273 | 🐛 5 | 🌐 Kotlin | 📅 2026-04-27 - Automatically generates an About this app section, with a list of used libraries.
* [Android Priority Job Queue](https://github.com/yigit/android-priority-jobqueue) ⭐ 3,380 | 🐛 140 | 🌐 Java | 📅 2022-10-22 - Implementation of a Job Queue to easily schedule jobs (tasks) that run in the background, improving UX and application stability.
* [Sensey](https://github.com/nisrulz/sensey) ⭐ 2,660 | 🐛 27 | 🌐 Java | 📅 2024-07-07 - Detecting gestures in a snap.
...
* [Gradle buildSrcVersions](https://github.com/jmfayard/buildSrcVersions) ⭐ 1,707 | 🐛 130 | 🌐 Kotlin | 📅 2025-08-16 - A kotlin dsl to simplify dependencies management
* [Licensee](https://github.com/cashapp/licensee) ⭐ 747 | 🐛 29 | 🌐 Kotlin | 📅 2026-04-30 - Licensee is a Gradle plugin which validates the licenses of your dependency graph match what you expect, or it fails your build!
...
* [Android Architecture Blueprints](https://github.com/android/architecture-samples) ⭐ 45,650 | 🐛 219 | 🌐 Kotlin | 📅 2026-04-28 - The Android Architecture Blueprints project demonstrates strategies to help solve or avoid common android problems.
* [Android Modular Architecture](https://github.com/VMadalin/kotlin-sample-app) ⭐ 2,439 | 🐛 4 | 🌐 Kotlin | 📅 2021-08-23 - Android Sample App using modular, clean, scalable, testable Architecture written in Kotlin following the best practices with Jetpack.
* [Kotlin MVVM example](https://github.com/emedinaa/kotlin-mvvm) ⭐ 547 | 🐛 3 | 🌐 Kotlin | 📅 2023-06-11 - Example about MVVM (Model View ViewModel) Pattern.
...
* [React Native](https://github.com/facebook/react-native) ⭐ 125,737 | 🐛 1,298 | 🌐 C++ | 📅 2026-05-01 - A framework for building native apps with React by Facebook.
* [Capacitor](https://github.com/ionic-team/capacitor) ⭐ 15,554 | 🐛 116 | 🌐 TypeScript | 📅 2026-04-30 - Build cross-platform Native Progressive Web Apps for iOS, Android, and the web. Very promising Cordova alternative.
* [Apache Cordova](https://github.com/apache/cordova-android) ⭐ 3,780 | 🐛 88 | 🌐 JavaScript | 📅 2026-04-24 - Cordova based applications are, at the core, applications written with web technology: HTML, CSS and JavaScript.
...
* [Scaloid](https://github.com/pocorall/scaloid) ⭐ 2,092 | 🐛 17 | 🌐 Scala | 📅 2024-06-13 - Library for less painful Android development with Scala.
...
* [Kotlin coding puzzles](https://github.com/igorwojda/kotlin-coding-puzzle) ⭐ 1,050 | 🐛 16 | 🌐 Kotlin | 📅 2026-04-29 - Set of programming challenges thats helps to improve whiteboard coding and problem-solving skills.
* [KAndroid](https://github.com/pawegio/KAndroid) ⭐ 892 | 🐛 6 | 🌐 Kotlin | 📅 2024-08-02 - Lightweight library providing useful extensions to eliminate boilerplate code in Android SDK.
...
* [Android Kotlin Samples](https://github.com/irontec/android-kotlin-samples) ⭐ 318 | 🐛 0 | 🌐 Kotlin | 📅 2019-01-24 - Some basic Android code samples written in Kotlin.
...
* [AppDimens](https://github.com/bodenberg/appdimens) ⭐ 13 | 🐛 7 | 🌐 HTML | 📅 2026-04-18 - Smart Responsive Dimensions for Any Screen (FX, DY, DP, SP, Logarithmic)
...
* [Booster](https://github.com/didi/booster) ⭐ 5,061 | 🐛 52 | 🌐 Kotlin | 📅 2026-03-15 - Booster is an optimization toolkit for Android applications.
* [awesome-android-performance](https://github.com/Juude/awesome-android-performance) ⭐ 2,883 | 🐛 1 | 📅 2019-05-07 - A list of awesome Android tutorials, videos and tools for performance optimization.

# Other Awesome Lists

Other amazingly awesome lists can be found in the [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,398 | 🐛 54 | 🌐 Ruby | 📅 2024-06-02 list.
