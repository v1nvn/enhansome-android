...
[<img src="https://raw.githubusercontent.com/jstumpp/awesome-android/master/awesome-android.png">](https://github.com/jstumpp/awesome-android) ⭐ 12,027 | 🐛 68 | 📅 2025-10-27
...
A curated list of awesome Android [libraries](#libraries) and [resources](#resources). For general Java libraries have a look at [awesome-java](https://github.com/akullpp/awesome-java) ⭐ 47,444 | 🐛 27 | 📅 2026-02-07.
...
* [MPAndroidChart](https://github.com/PhilJay/MPAndroidChart) ⭐ 38,225 | 🐛 2,189 | 🌐 Java | 📅 2025-06-05 - An Android chart and graph library supporting scaling and dragging by gesture.
* [HelloCharts](https://github.com/lecho/hellocharts-android) ⭐ 7,768 | 🐛 293 | 🌐 Java | 📅 2021-06-01 - Chart and graph library with support for scaling, scrolling and animations.
...
* [Dagger 2](https://github.com/google/dagger) ⭐ 17,708 | 🐛 361 | 🌐 Java | 📅 2026-03-30 - A fast dependency injector for Android and Java.
...
* [Libgdx](https://libgdx.badlogicgames.com/) - Cross-platform game engine and SDK. [Open Source](https://github.com/libGDX/libGDX) ⭐ 24,961 | 🐛 333 | 🌐 Java | 📅 2026-03-25
...
* [Litho (By Facebook)](https://github.com/facebook/litho) ⭐ 7,779 | 🐛 114 | 🌐 Kotlin | 📅 2026-03-30 - A declarative framework for building efficient UIs on Android.
...
* [MaterialDrawer](https://github.com/mikepenz/MaterialDrawer) ⭐ 11,654 | 🐛 11 | 🌐 Kotlin | 📅 2026-03-30 - Simple take on a material design navigation drawer.
...
* [RecyclerTabLayout](https://github.com/nshmura/RecyclerTabLayout) ⭐ 1,356 | 🐛 13 | 🌐 Java | 📅 2019-08-29 - An efficient TabLayout library implemented with RecyclerView.
...
* [Android View Animations](https://github.com/daimajia/AndroidViewAnimations) ⭐ 12,471 | 🐛 66 | 🌐 Java | 📅 2021-08-18 - Cute view animation collection.
...
* [CircularImageView](https://github.com/Pkmmte/CircularImageView) ⭐ 1,173 | 🐛 47 | 🌐 Java | 📅 2017-08-16 - Custom view for circular images while maintaining the best draw performance.
...
* [MaterialSearchBar](https://github.com/mancj/MaterialSearchBar) ⭐ 2,019 | 🐛 84 | 🌐 Java | 📅 2022-07-07 - Material Design Search Bar for Android
...
* [Glide](https://github.com/bumptech/glide) ⭐ 35,029 | 🐛 635 | 🌐 Java | 📅 2026-03-30 - An image loading and caching library for Android focused on smooth scrolling, Recommended by Google.
* [Picasso](https://github.com/square/picasso) ⭐ 19,027 | 🐛 214 | 🌐 Kotlin | 📅 2024-11-06 - A powerful image downloading and caching library for Android.
* [Fresco](https://github.com/facebook/fresco) ⭐ 17,160 | 🐛 259 | 🌐 Java | 📅 2026-03-30 - An Android library for managing images and the memory they use.
* [Universal Image Loader](https://github.com/nostra13/Android-Universal-Image-Loader) ⭐ 17,026 | 🐛 460 | 🌐 Java | 📅 2024-08-15 - Asynchronous, out of the box loading and caching of images.
* [Coil](https://github.com/coil-kt/coil) ⭐ 11,751 | 🐛 60 | 🌐 Kotlin | 📅 2026-03-28 - Image loading for Android backed by Kotlin Coroutines.
...
* [Exoplayer](https://github.com/google/ExoPlayer) ⭐ 21,934 | 🐛 632 | 🌐 Java | 📅 2025-12-23 - ExoPlayer is an application level media player for Android, allow  playing audio and video both locally and over the Internet.
...
* [Gson](https://github.com/google/gson) ⭐ 24,332 | 🐛 335 | 🌐 Java | 📅 2026-03-19 - Gson is a Java library used for serializing and deserializing Java objects from and into JSON.
* [Moshi](https://github.com/square/moshi) ⭐ 10,121 | 🐛 98 | 🌐 Kotlin | 📅 2026-03-27 - A modern JSON library for Android and Java.
* [Jackson JSON Processor](https://github.com/FasterXML/jackson) ⭐ 9,691 | 🐛 0 | 📅 2026-03-11 - High-performance JSON processor.
...
* [OkHttp](https://github.com/square/okhttp) ⭐ 46,915 | 🐛 94 | 🌐 Kotlin | 📅 2026-03-31 - An HTTP+SPDY client for Android and Java applications.
* [Ion](https://github.com/koush/ion) ⭐ 6,260 | 🐛 337 | 🌐 Java | 📅 2024-02-01 - Good networking library for android.
* [Fast-Android-Networking](https://github.com/amitshekhariitbhu/Fast-Android-Networking) ⭐ 5,889 | 🐛 232 | 🌐 Java | 📅 2026-02-05 - A Complete Fast Android Networking Library that also support HTTP/2.
...
* [timber](https://github.com/JakeWharton/timber) ⭐ 10,810 | 🐛 61 | 🌐 Kotlin | 📅 2026-03-31 - A logger with a small, extensible API which provides utility on top of Android's normal Log class.
...
* [SQLite Asset Helper](https://github.com/jgilfelt/android-sqlite-asset-helper) ⭐ 2,222 | 🐛 78 | 🌐 Java | 📅 2021-09-23 - manage database creation and version management using an application's raw asset files.
...
* [Nitrite Database](https://github.com/dizitart/nitrite-database) ⭐ 896 | 🐛 5 | 🌐 Java | 📅 2026-03-30 - A NoSQL embedded document store for Android with MongoDb like API.
...
* [Robotium](https://github.com/robotiumtech/robotium) ⭐ 2,858 | 🐛 90 | 🌐 Java | 📅 2021-09-28 - Test automation framework for black-box UI tests.
...
* [LeakCanary](https://github.com/square/leakcanary) ⭐ 29,917 | 🐛 154 | 🌐 Kotlin | 📅 2026-03-24 - Catch memory leaks as they occur.
* [Otto](https://github.com/square/otto) ⚠️ Archived - Event Bus for Android.
* [EasyDeviceInfo](https://github.com/nisrulz/easydeviceinfo) ⭐ 1,785 | 🐛 10 | 🌐 Java | 📅 2024-07-12 - Get device information in a super easy way.
...
* [Android Debug Bridge - ADB](https://github.com/mzlogin/awesome-adb/blob/master/README.en.md) ⭐ 12,260 | 🐛 50 | 📅 2024-12-18 - a command-line tool to assist in debugging Android-powered devices
...
* [ADB Enhanced](https://github.com/ashishb/adb-enhanced) ⭐ 1,366 | 🐛 2 | 🌐 Python | 📅 2026-03-30 - a command-line wrapper around ADB for developers, so that, developers don't have to remember esoteric version-dependent commands
...
* [Permission Dispatcher](https://github.com/permissions-dispatcher/PermissionsDispatcher) ⭐ 11,198 | 🐛 31 | 🌐 Java | 📅 2023-11-10 - Simple annotation-based API to handle runtime permissions.
...
* [Guava: Google Core Libraries for Java](https://github.com/google/guava) ⭐ 51,514 | 🐛 726 | 🌐 Java | 📅 2026-03-23 - Collections, caching, primitives support, concurrency libraries, common annotations, string processing, I/O, and so forth.
* [RxJava](https://github.com/ReactiveX/RxJava) ⭐ 48,437 | 🐛 20 | 🌐 Java | 📅 2026-03-30- RxJava – Reactive Extensions for the JVM – a library for composing asynchronous and event-based programs using observable sequences for the Java VM.
* [ZXing Android-Integration](https://github.com/zxing/zxing) ⭐ 33,907 | 🐛 10 | 🌐 Java | 📅 2026-03-16 - Integration with Barcode Scanner via Intent.
* [RxAndroid](https://github.com/ReactiveX/RxAndroid) ⭐ 20,155 | 🐛 1 | 🌐 Java | 📅 2026-03-24 - Adds minimum RxJava bindings for easy writing of reactive Android java code.
* [Flexbox Layout](https://github.com/google/flexbox-layout) ⭐ 18,352 | 🐛 133 | 🌐 Kotlin | 📅 2024-04-22 - FlexboxLayout is a library which brings the similar capabilities of CSS Flexible Box Layout Module to Android. 
...
* [AboutLibraries](https://github.com/mikepenz/AboutLibraries) ⭐ 4,253 | 🐛 10 | 🌐 Kotlin | 📅 2026-03-30 - Automatically generates an About this app section, with a list of used libraries.
...
* [Android Architecture Blueprints](https://github.com/android/architecture-samples) ⭐ 45,624 | 🐛 218 | 🌐 Kotlin | 📅 2026-03-25 - The Android Architecture Blueprints project demonstrates strategies to help solve or avoid common android problems.
...
* [React Native](https://github.com/facebook/react-native) ⭐ 125,658 | 🐛 1,282 | 🌐 C++ | 📅 2026-03-31 - A framework for building native apps with React by Facebook.
* [Capacitor](https://github.com/ionic-team/capacitor) ⭐ 15,370 | 🐛 112 | 🌐 TypeScript | 📅 2026-03-27 - Build cross-platform Native Progressive Web Apps for iOS, Android, and the web. Very promising Cordova alternative.
* [Apache Cordova](https://github.com/apache/cordova-android) ⭐ 3,778 | 🐛 94 | 🌐 JavaScript | 📅 2026-03-30 - Cordova based applications are, at the core, applications written with web technology: HTML, CSS and JavaScript.
...
Other amazingly awesome lists can be found in the [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,313 | 🐛 50 | 🌐 Ruby | 📅 2024-06-02 list.
