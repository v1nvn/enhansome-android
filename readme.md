...
[<img src="https://raw.githubusercontent.com/jstumpp/awesome-android/master/awesome-android.png">](https://github.com/jstumpp/awesome-android) ⭐ 12,035 | 🐛 69 | 📅 2025-10-27
...
A curated list of awesome Android [libraries](#libraries) and [resources](#resources). For general Java libraries have a look at [awesome-java](https://github.com/akullpp/awesome-java) ⭐ 47,474 | 🐛 30 | 📅 2026-02-07.
...
* [MPAndroidChart](https://github.com/PhilJay/MPAndroidChart) ⭐ 38,230 | 🐛 2,189 | 🌐 Java | 📅 2025-06-05 - An Android chart and graph library supporting scaling and dragging by gesture.
...
* [WilliamChart](https://github.com/diogobernardino/WilliamChart) ⭐ 5,110 | 🐛 36 | 🌐 Kotlin | 📅 2025-10-04 - Chart library with good motion capabilities.
...
* [Dagger 2](https://github.com/google/dagger) ⭐ 17,707 | 🐛 362 | 🌐 Java | 📅 2026-03-30 - A fast dependency injector for Android and Java.
...
* [Libgdx](https://libgdx.badlogicgames.com/) - Cross-platform game engine and SDK. [Open Source](https://github.com/libGDX/libGDX) ⭐ 24,970 | 🐛 335 | 🌐 Java | 📅 2026-03-31
...
* [Litho (By Facebook)](https://github.com/facebook/litho) ⭐ 7,781 | 🐛 114 | 🌐 Kotlin | 📅 2026-03-30 - A declarative framework for building efficient UIs on Android.
...
* [Glide](https://github.com/bumptech/glide) ⭐ 35,030 | 🐛 636 | 🌐 Java | 📅 2026-04-02 - An image loading and caching library for Android focused on smooth scrolling, Recommended by Google.
...
* [Fresco](https://github.com/facebook/fresco) ⭐ 17,158 | 🐛 259 | 🌐 Java | 📅 2026-04-01 - An Android library for managing images and the memory they use.
* [Universal Image Loader](https://github.com/nostra13/Android-Universal-Image-Loader) ⭐ 17,025 | 🐛 460 | 🌐 Java | 📅 2024-08-15 - Asynchronous, out of the box loading and caching of images.
* [Coil](https://github.com/coil-kt/coil) ⭐ 11,752 | 🐛 60 | 🌐 Kotlin | 📅 2026-03-28 - Image loading for Android backed by Kotlin Coroutines.
...
* [Gson](https://github.com/google/gson) ⭐ 24,331 | 🐛 338 | 🌐 Java | 📅 2026-04-01 - Gson is a Java library used for serializing and deserializing Java objects from and into JSON.
* [Moshi](https://github.com/square/moshi) ⭐ 10,121 | 🐛 98 | 🌐 Kotlin | 📅 2026-03-31 - A modern JSON library for Android and Java.
* [Jackson JSON Processor](https://github.com/FasterXML/jackson) ⭐ 9,695 | 🐛 0 | 📅 2026-03-11 - High-performance JSON processor.
...
* [OkHttp](https://github.com/square/okhttp) ⭐ 46,922 | 🐛 95 | 🌐 Kotlin | 📅 2026-04-01 - An HTTP+SPDY client for Android and Java applications.
...
* [LeakCanary](https://github.com/square/leakcanary) ⭐ 29,918 | 🐛 156 | 🌐 Kotlin | 📅 2026-03-24 - Catch memory leaks as they occur.
...
* [Android Debug Bridge - ADB](https://github.com/mzlogin/awesome-adb/blob/master/README.en.md) ⭐ 12,264 | 🐛 50 | 📅 2024-12-18 - a command-line tool to assist in debugging Android-powered devices
...
* [Kommunicate Live Chat SDK](https://github.com/Kommunicate-io/Kommunicate-Android-Chat-SDK) ⭐ 79 | 🐛 1 | 🌐 Java | 📅 2026-04-01 - Kommunicate provides open source live chat sdk in android. Kommunicate lets you add real time live chat and in-app messaging in your mobile (android, iOS) applications and website for customer support.
...
* [Guava: Google Core Libraries for Java](https://github.com/google/guava) ⭐ 51,517 | 🐛 727 | 🌐 Java | 📅 2026-04-01 - Collections, caching, primitives support, concurrency libraries, common annotations, string processing, I/O, and so forth.
* [RxJava](https://github.com/ReactiveX/RxJava) ⭐ 48,437 | 🐛 21 | 🌐 Java | 📅 2026-03-30- RxJava – Reactive Extensions for the JVM – a library for composing asynchronous and event-based programs using observable sequences for the Java VM.
* [ZXing Android-Integration](https://github.com/zxing/zxing) ⭐ 33,908 | 🐛 10 | 🌐 Java | 📅 2026-03-16 - Integration with Barcode Scanner via Intent.
...
* [AboutLibraries](https://github.com/mikepenz/AboutLibraries) ⭐ 4,258 | 🐛 10 | 🌐 Kotlin | 📅 2026-03-30 - Automatically generates an About this app section, with a list of used libraries.
...
* [React Native](https://github.com/facebook/react-native) ⭐ 125,673 | 🐛 1,257 | 🌐 C++ | 📅 2026-04-01 - A framework for building native apps with React by Facebook.
* [Capacitor](https://github.com/ionic-team/capacitor) ⭐ 15,378 | 🐛 111 | 🌐 TypeScript | 📅 2026-03-31 - Build cross-platform Native Progressive Web Apps for iOS, Android, and the web. Very promising Cordova alternative.
* [Apache Cordova](https://github.com/apache/cordova-android) ⭐ 3,780 | 🐛 94 | 🌐 JavaScript | 📅 2026-04-01 - Cordova based applications are, at the core, applications written with web technology: HTML, CSS and JavaScript.
...
Other amazingly awesome lists can be found in the [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,319 | 🐛 50 | 🌐 Ruby | 📅 2024-06-02 list.
