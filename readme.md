...
[<img src="https://raw.githubusercontent.com/jstumpp/awesome-android/master/awesome-android.png">](https://github.com/jstumpp/awesome-android) ⭐ 12,050 | 🐛 70 | 📅 2025-10-27
...
A curated list of awesome Android [libraries](#libraries) and [resources](#resources). For general Java libraries have a look at [awesome-java](https://github.com/akullpp/awesome-java) ⭐ 47,569 | 🐛 31 | 📅 2026-02-07.
...
* [HelloCharts](https://github.com/lecho/hellocharts-android) ⭐ 7,710 | 🐛 293 | 🌐 Java | 📅 2021-06-01 - Chart and graph library with support for scaling, scrolling and animations.
...
* [Dagger 2](https://github.com/google/dagger) ⭐ 17,709 | 🐛 359 | 🌐 Java | 📅 2026-04-09 - A fast dependency injector for Android and Java.
...
* [Libgdx](https://libgdx.badlogicgames.com/) - Cross-platform game engine and SDK. [Open Source](https://github.com/libGDX/libGDX) ⭐ 24,994 | 🐛 334 | 🌐 Java | 📅 2026-04-08
...
* [Litho (By Facebook)](https://github.com/facebook/litho) ⭐ 7,777 | 🐛 116 | 🌐 Kotlin | 📅 2026-04-06 - A declarative framework for building efficient UIs on Android.
...
* [PagerSlidingTabStrip](https://github.com/astuetz/PagerSlidingTabStrip) ⭐ 153 | 🐛 228 | 🌐 Java | 📅 2018-10-06 - An interactive indicator to navigate between the different pages of a ViewPager.
...
* [ShapeImageView](https://github.com/siyamed/android-shape-imageview) ⭐ 2,666 | 🐛 63 | 🌐 Java | 📅 2019-07-27 - Library to display images in different shapes.
...
* [CircularImageView](https://github.com/Pkmmte/CircularImageView) ⭐ 1,172 | 🐛 47 | 🌐 Java | 📅 2017-08-16 - Custom view for circular images while maintaining the best draw performance.
...
* [Glide](https://github.com/bumptech/glide) ⭐ 35,027 | 🐛 633 | 🌐 Java | 📅 2026-04-07 - An image loading and caching library for Android focused on smooth scrolling, Recommended by Google.
* [Picasso](https://github.com/square/picasso) ⭐ 18,966 | 🐛 214 | 🌐 Kotlin | 📅 2024-11-06 - A powerful image downloading and caching library for Android.
* [Fresco](https://github.com/facebook/fresco) ⭐ 17,155 | 🐛 259 | 🌐 Java | 📅 2026-04-09 - An Android library for managing images and the memory they use.
* [Universal Image Loader](https://github.com/nostra13/Android-Universal-Image-Loader) ⭐ 16,963 | 🐛 460 | 🌐 Java | 📅 2024-08-15 - Asynchronous, out of the box loading and caching of images.
* [Coil](https://github.com/coil-kt/coil) ⭐ 11,752 | 🐛 63 | 🌐 Kotlin | 📅 2026-04-09 - Image loading for Android backed by Kotlin Coroutines.
...
* [Gson](https://github.com/google/gson) ⭐ 24,290 | 🐛 339 | 🌐 Java | 📅 2026-04-05 - Gson is a Java library used for serializing and deserializing Java objects from and into JSON.
...
* [OkHttp](https://github.com/square/okhttp) ⭐ 46,923 | 🐛 95 | 🌐 Kotlin | 📅 2026-04-09 - An HTTP+SPDY client for Android and Java applications.
...
* [Realm](https://github.com/realm/realm-java) ⭐ 11,485 | 🐛 396 | 🌐 Java | 📅 2025-09-15 - The alternative to SQLite and ORMs: Simple, modern and fast! Object oriented API and multi platform support.
* [SQLite Asset Helper](https://github.com/jgilfelt/android-sqlite-asset-helper) ⭐ 2,212 | 🐛 78 | 🌐 Java | 📅 2021-09-23 - manage database creation and version management using an application's raw asset files.
...
* [LeakCanary](https://github.com/square/leakcanary) ⭐ 29,917 | 🐛 158 | 🌐 Kotlin | 📅 2026-03-24 - Catch memory leaks as they occur.
...
* [Android Debug Bridge - ADB](https://github.com/mzlogin/awesome-adb/blob/master/README.en.md) ⭐ 12,269 | 🐛 50 | 📅 2024-12-18 - a command-line tool to assist in debugging Android-powered devices
...
* [ADB Enhanced](https://github.com/ashishb/adb-enhanced) ⭐ 1,366 | 🐛 4 | 🌐 Python | 📅 2026-04-09 - a command-line wrapper around ADB for developers, so that, developers don't have to remember esoteric version-dependent commands
...
* [Guava: Google Core Libraries for Java](https://github.com/google/guava) ⭐ 51,514 | 🐛 727 | 🌐 Java | 📅 2026-04-09 - Collections, caching, primitives support, concurrency libraries, common annotations, string processing, I/O, and so forth.
* [RxJava](https://github.com/ReactiveX/RxJava) ⭐ 48,376 | 🐛 23 | 🌐 Java | 📅 2026-04-09- RxJava – Reactive Extensions for the JVM – a library for composing asynchronous and event-based programs using observable sequences for the Java VM.
* [ZXing Android-Integration](https://github.com/zxing/zxing) ⭐ 33,910 | 🐛 3 | 🌐 Java | 📅 2026-04-08 - Integration with Barcode Scanner via Intent.
* [RxAndroid](https://github.com/ReactiveX/RxAndroid) ⭐ 20,099 | 🐛 1 | 🌐 Java | 📅 2026-03-24 - Adds minimum RxJava bindings for easy writing of reactive Android java code.
...
* [Gradle Retrolambda Plugin](https://github.com/evant/gradle-retrolambda) ⭐ 5,276 | 🐛 76 | 🌐 Java | 📅 2023-07-24 - Java 8 Lambdas on Android!
* [AboutLibraries](https://github.com/mikepenz/AboutLibraries) ⭐ 4,261 | 🐛 12 | 🌐 Kotlin | 📅 2026-04-09 - Automatically generates an About this app section, with a list of used libraries.
...
* [Android Architecture Blueprints](https://github.com/android/architecture-samples) ⭐ 45,633 | 🐛 219 | 🌐 Kotlin | 📅 2026-04-09 - The Android Architecture Blueprints project demonstrates strategies to help solve or avoid common android problems.
...
* [React Native](https://github.com/facebook/react-native) ⭐ 125,678 | 🐛 1,301 | 🌐 C++ | 📅 2026-04-10 - A framework for building native apps with React by Facebook.
* [Capacitor](https://github.com/ionic-team/capacitor) ⭐ 15,424 | 🐛 110 | 🌐 TypeScript | 📅 2026-04-09 - Build cross-platform Native Progressive Web Apps for iOS, Android, and the web. Very promising Cordova alternative.
...
Other amazingly awesome lists can be found in the [awesome-awesomeness](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,344 | 🐛 50 | 🌐 Ruby | 📅 2024-06-02 list.
